                        ...
                        <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <input style="height: 50px;" type="file" accept=".png,.jpg.jpeg" class="form-control" name="banner[]" id="banner" multiple>
                                    <div class="error" id="facility_name_error"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <button style="margin-top: 10px;" type="submit" id="submit" name="banner_submit" value="banner_submit" class="btn btn-success">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <table id="example" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?');" href="<?=base_url()?>admin_delete/<?=$tips_list_result->id?>/tbl_catalogue"><i class="fa-solid fa-trash"></i></a>	
                                                </td>
                                            </tr>
                                        <?php }}?>
                                        </tbody>
