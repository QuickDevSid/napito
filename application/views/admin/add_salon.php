                        ...
                        <form method="post" name="customer_form" id="customer_form" enctype="multipart/form-data">                    
                            ...
                            <div id="step2" class="form-step single_branch_details_div" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select chosen-select" name="payment_options[]" id="payment_options" multiple>
                                                ...
                                                <option value="Card" <?php if (!empty($single) && !empty($self_branch) && in_array('Card',$payment_options)) {
                                                                        echo 'selected';
                                                                    } ?>>Card</option>
                                                <option value="Cheque" <?php if (!empty($single) && !empty($self_branch) && in_array('Cheque',$payment_options)) {
                                                                        echo 'selected';
                                                                    } ?>>Cheque</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label>Subscriptions<b class="require">*</b></label>
