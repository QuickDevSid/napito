                    ...
                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Validity<br><small>(In Days)</small></th>
                                                <th>Features</th>
                                                <th>Whatsapp Features</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($subscription_list_result->include_wp == '1'){ ?>
                                                        <a onclick="showPopup('subscriptionWPFeaturesModal_<?=$subscription_list_result->id;?>')" title="Subscription Whatsapp Features" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#subscriptionWPFeaturesModal_<?=$subscription_list_result->id;?>">
                                                            <i class="fa-solid fa-bell"></i>
                                                        </a>
                                                        <!-- Subscription Features Modal -->
                                                        <div class="modal fade" id="subscriptionWPFeaturesModal_<?=$subscription_list_result->id;?>" tabindex="-1" aria-labelledby="subscriptionWPFeaturesModalLabel_<?=$subscription_list_result->id;?>" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="subscriptionWPFeaturesModalLabel_<?=$subscription_list_result->id;?>">Subscription Whatsapp Features
                                                                    <p><b>Total: <?=$subscription_list_result->wp_coins_qty . ' Coins'; ?></b></p>
                                                                </h5>           
                                                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="float:none !important; position:absolute;right:10px;top:10px;"  onclick="closePopup('subscriptionWPFeaturesModal_<?=$subscription_list_result->id;?>')">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <table id="wp_features_table_<?=$subscription_list_result->id;?>" class="table table-striped responsive-utilities jambo_table features_table">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th style="width:10%;">Sr. No.</th>
                                                                                    <th style="width:35%;">Description</th>
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                                    $subscription_features = $this->Admin_model->get_subscription_wp_features_list(51,explode(',',$subscription_list_result->whatsapp_notification_features));
                                                                                    if($subscription_features && !empty($subscription_features)){
                                                                                        $i=1;
                                                                                        foreach($subscription_features as $subscription_features_result){
                                                                                ?>
                                                ...
                                                <td><?=count($is_subscription_applied);?></td>
                                                <td>
                                                    <?php if($subscription_list_result->include_wp == '1'){ ?>
                                                        <a title="Whatsapp Add On Plans" style="background-color: #25D366; color: white;" class="btn btn-info" href="<?=base_url()?>whatsapp-addon-plans/<?=$subscription_list_result->id?>"><i class="fa-brands fa-whatsapp"></i></a>	
                                                    <?php } ?>
