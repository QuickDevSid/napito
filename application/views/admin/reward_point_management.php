                        ...
                        <form method="post" name="reward_point_form" id="reward_point_form" enctype="multipart/form-data">
                            <div class="row" style="display: flex;flex-wrap:wrap;">
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control" name="rs_per_reward" id="rs_per_reward">
                                        ...
                                        <option value="0.5" <?php if (!empty($single) && $single->rs_per_reward == 0.5) {
                                                                echo ' selected';
                                                            } ?>>0.5</option>
                                        <option value="1" <?php if (!empty($single) && $single->rs_per_reward == 1) {
                                                                echo ' selected';
                                                            } ?>>1</option>
                                        <option value="1.5" <?php if (!empty($single) && $single->rs_per_reward == 1.5) {
                                                                echo ' selected';
                                                            } ?>>1.5</option>
                                        <option value="2" <?php if (!empty($single) && $single->rs_per_reward == 2) {
                                                                echo ' selected';
                                                            } ?>>2</option>
                                        <option value="2.5" <?php if (!empty($single) && $single->rs_per_reward == 2.5) {
                                                                echo ' selected';
                                                            } ?>>2.5</option>
                                        <option value="3" <?php if (!empty($single) && $single->rs_per_reward == 3) {
                                                                echo ' selected';
                                                            } ?>>3</option>
                                        <option value="3.5" <?php if (!empty($single) && $single->rs_per_reward == 3.5) {
                                                                echo ' selected';
                                                            } ?>>3.5</option>
                                        <option value="4" <?php if (!empty($single) && $single->rs_per_reward == 4) {
                                                                echo ' selected';
                                                            } ?>>4</option>
                                        <option value="4.5" <?php if (!empty($single) && $single->rs_per_reward == 4.5) {
                                                                echo ' selected';
                                                            } ?>>4.5</option>
                                        <option value="5" <?php if (!empty($single) && $single->rs_per_reward == 5) {
                                                                echo ' selected';
                                                            } ?>>5</option>
                                    </select>
                                    <input autocomplete="off" class="input-content col-md-6 col-xs-12" type="hidden" name="id" id="id" value="<?php if (!empty($single)) {
                                                                                                                                                    echo $single->id;
                                                                                                                                                } ?>">
                                </div>
                            <!-- </div>
                            <div class="row"> -->
                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" name="minimum_reward_required" id="minimum_reward_required" placeholder="Enter minimum required for use" value="<?php if (!empty($single)) {
                                                                                                                                                                                                                    echo $single->minimum_reward_required;
                                                                                                                                                                                                                } ?>">
                                </div>
                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <label>Maximum Reward can be use <b class="require">*</b></label>
                                    <input autocomplete="off" type="text" class="form-control" name="maximum_reward_required" id="maximum_reward_required" placeholder="Enter maximum reward can be use" value="<?php if (!empty($single)) {
                                                                                                                                                                                                                    echo $single->maximum_reward_required;
                                                                                                                                                                                                                } ?>">
                                </div>
