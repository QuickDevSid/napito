                    ...
                    <table class="table table-striped responsive-utilities jambo_table"style="width: 100%;" id="example">
                        <thead>
                            <tr>
                                ...
                                <th>Notification</th>
                                <th>Sent On</th>
                                <th>Notification Delivery<br>Status</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#example').DataTable({
            ...
            // scrollCollapse: true,
            "ajax":{
                "url" : "<?=base_url();?>salon/Ajax_controller/get_notification_report_data_ajx",
                "type": "POST",
                "data": function (d) {
    ...
    function showGatewayResponse(id){
        $.ajax({
            url: "<?= base_url(); ?>salon/Ajax_controller/get_notification_gateway_response_ajx",
            method: 'POST',
            data: { id: id },
    ...
    function showMessage(id){
        $.ajax({
            url: "<?= base_url(); ?>salon/Ajax_controller/get_notification_content_ajx",
            method: 'POST',
            data: { id: id },
            success: function(response) {
