                        ...
                        <div class="container">
                            ...
                            <div class="row" style="display: flex;flex-wrap:wrap">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <input type="file" class="form-control" name="category_image" id="category_image" accept=".jpg ,.pdf ,.jpeg, .png"  value="<?php if (!empty($single)) {echo $single->category_image;  } ?>">
                                    ...
                                    <div class="form-group col-md-4 min" >
                                    ...
                                    <div class="form-group col-md-4 max">
                                    ...
                                    <div class="form-group col-md-4 service_discount" style="display: none;">
                                    ...
                                    <div class="form-group col-md-4 reward_point" style="display: none;">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label>Long Description <b class="require">*</b></label>
