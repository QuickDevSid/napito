                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group service_name">
                                           ...
                                           <select class="form-select form-control chosen-select" name="service_name[]" id="service_name" multiple>
												<?php if(!empty($services)){ foreach($services as $services_result){
                                                    ...
                                                    ?>
												<option value="<?=$services_result->id?>" <?php if(!empty($service_added) && in_array($services_result->id,$service_added)){?>selected="selected"<?php }?>><?=$services_result->sub_category_name . '|' . $services_result->sub_category_marathi; ?> -> <?=$services_result->service_name . '|' . $services_result->service_name_marathi; ?> <?=$service_gender;?></option>
												<?php }}?>
											</select> 
                                        </div>
