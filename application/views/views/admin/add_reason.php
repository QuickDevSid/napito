					...
					<div class="x_content">
						<form id="make_form" name="make_form" method="post" enctype="multipart/form-data" data-parsley-validate>
							<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
								...
								<input type="text" placeholder="Enter Category" autocomplete="off" type="text" id="reason" class="form-control" name="reason" required value="<?php if (!empty($single)) {
																																													echo $single->reason;
																																												} ?>">
								<div class="error" id="status_error"></div>
								<input type="hidden" id="id" class="form-control" name="id" value="<?php if (!empty($single)) {
																										echo $single->id;
																									} ?>" />
							</div>
							<div class="clearfix"></div>
