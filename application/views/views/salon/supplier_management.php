...
<style type="text/css">
    ...
    table.table.table-striped.responsive-utilities.jambo_table.dataTable.no-footer {
        width: 100% !important;
    }
    .dataTables_paginate {
    float: right;
                            ...
                            <form method="post" name="employee_form" id="employee_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" placeholder="Enter Supplier Name" class="form-control" name="name" id="name" value="<?php if (!empty($single)) {
                                                                                                                                                    echo $single->name;
                                                                                                                                                } ?>">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" placeholder="Enter Contact Person Name" class="form-control" name="person_name" id="person_name" value="<?php if (!empty($single)) {
                                ...
                                <div class="row"> -->
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <input autocomplete="off" class="form-control" type="text" name="mobile_no" id="mobile_no" value="<?php if (!empty($single)) {
                                                                                                                                                echo $single->mobile_no;
                                                                                                                                            } ?>" placeholder="Enter Mobile No.">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <label>Email</label>
                                        <input autocomplete="off" class="form-control" type="text" name="email" id="email" value="<?php if (!empty($single)) {
                                                                                                                                        echo $single->email;
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <textarea autocomplete="off" class="form-control" name="address" id="address"><?php if (!empty($single)) {
                                                                                                                            echo $single->address;
                                                                                                                        } ?></textarea>
                                    </div>
                                </div>
