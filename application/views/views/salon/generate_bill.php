                        ...
                        <form method="post" name="payment_form_<?=$booking->id;?>" id="payment_form_<?=$booking->id;?>" action="<?=base_url();?>generate-bill/<?=base64_encode($booking->id);?>">
                            <div class="row">
                                <div class="col-lg-9 col_resp">
                                    <div class="calender_booking_details service_details_div service_details_box" style="background-color: #f7f7ff;height: 500px; overflow-y: auto; border: 0.5px solid #afafaf;">
                                        <table class="std-tbl" style="width:100%;">
                                            <thead>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12" id="message_type_div_<?=$booking->id;?>" style="display:none;">
