						...
						<div class="container"> 
							...
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<!-- <input type="radio" class=" " name="booking_time_range" id="booking_range_one" value="30" <?php if(!empty($single_rules) && $single_rules->booking_time_range == "15"){?>checked="checked"<?php }?>><span>Before 30 Minutes</span>     -->
									<input type="radio" class=" " name="booking_time_range" id="booking_range_twwo" value="15" <?php if(!empty($single_rules) && $single_rules->booking_time_range == "30"){?>checked="checked"<?php }?>><span>Before 15 Minutes</span>    
								</div>  
