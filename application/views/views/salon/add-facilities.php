                                            ...
                                            <tr>
                                               ...
                                               <td><button class="photo-btn btn btn-light"><a target="_blank" href="<?=base_url()?>admin_assets\images\facilities_image/<?=$facilities_list_result->facilities_image?>" target="_blank">View Photo</a></button> </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Edit" class="btn btn-primary" href="<?=base_url()?>add-facilities/<?=$facilities_list_result->id?>"><i class="fa-solid fa-pen-to-square"></i></a>   
                                                </td>
                                            </tr>
                                        <?php }}?>
                                        </tbody>
...
<script>
      $(document).ready(function () {
			...
			$('.add_facilities').addClass('active_cc');
		});
</script>
