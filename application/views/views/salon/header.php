...
$steps = [
    ["flag" => "0", "name" => "Registration", "link" => base_url() . "complete-profile", "next_link" => "store-profile"],
    ["flag" => "1", "name" => "Store Profile", "link" => base_url() . "store-profile", "next_link" => "working-hours"],
    ["flag" => "2", "name" => "Working Hours", "link" => base_url() . "working-hours", "next_link" => "salon-bank-details"],
    ["flag" => "3", "name" => "Bank Details", "link" => base_url() . "salon-bank-details", "next_link" => "salon-location"],
    ["flag" => "4", "name" => "Store Location", "link" => base_url() . "salon-location", "next_link" => "add-salon-facility"],
    ["flag" => "5", "name" => "Store Facilities", "link" => base_url() . "add-salon-facility", "next_link" => "working-hours?active=add_shifts_page"],
    ["flag" => "6", "name" => "Shifts", "link" => base_url() . "working-hours?active=add_shifts_page", "next_link" => "add-product"],
    ["flag" => "7", "name" => "Products", "link" => base_url() . "add-product", "next_link" => "add-salon-services"],
    ["flag" => "8", "name" => "Services", "link" => base_url() . "add-salon-services", "next_link" => "add-membership"],
    ["flag" => "9", "name" => "Memberships", "link" => base_url() . "add-membership", "next_link" => "add-package"],
    ["flag" => "10", "name" => "Packages", "link" => base_url() . "add-package", "next_link" => "add-coupon-code"],
    ["flag" => "11", "name" => "Coupons", "link" => base_url() . "add-coupon-code", "next_link" => "add-offers"],
    ["flag" => "12", "name" => "Offers", "link" => base_url() . "add-offers", "next_link" => "add-gift-card"],
    ["flag" => "13", "name" => "Giftcard", "link" => base_url() . "add-gift-card", "next_link" => "add-reward-point"],
    ["flag" => "14", "name" => "Rewards", "link" => base_url() . "add-reward-point", "next_link" => "add_automated_marketing?type=all"],
    ["flag" => "15", "name" => "Automated Marketing", "link" => base_url() . "add_automated_marketing?type=all", "next_link" => "employee_incentive_master"],
    ["flag" => "16", "name" => "Employee Incentives", "link" => base_url() . "employee_incentive_master", "next_link" => "add_employee"],
    ["flag" => "17", "name" => "Employees", "link" => base_url() . "add_employee" . $redirect, "next_link" => "add-course"],
    ["flag" => "18", "name" => "Academy Courses", "link" => base_url() . "add-course", "next_link" => "complete-profile?loader=true"]
];
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li id="asign_membership" class="<?php if (empty(array_intersect($check_array, $feature_slugs))) {
                                        ...
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a class="<?php if (empty(array_intersect(['asign-giftcard-list'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>asign_giftcard" href="<?= base_url(); ?>asign-giftcard-list">Assign Giftcard List</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <?php $check_array = ['giftcards', 'coupons', 'birthday', 'anniversary', 'store-reviews-list', 'coin_history', 'salon-mobile-banner', 'add-catlogue-salon', 'store-images', 'cancel_appointment', 'service_repeat', 'lost_customer', 'offer', 'customize_message']; ?>
                                    <li id="marketing" class="<?php if (empty(array_intersect($check_array, $feature_slugs))) {
                                        ...
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a class="<?php if (empty(array_intersect(['cancel_appointment'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>cancel-appointment-setup" href="<?= base_url(); ?>cancel_appointment">Cancel Appointment</a></li>
                                    ...
                                    <li id="reports" class="<?php if (empty(array_intersect($check_array, $feature_slugs))) {
                                        ...
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a class="<?php if (empty(array_intersect(['sales-report'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>sales-report" href="<?= base_url(); ?>sales-report">Sales</a></li>
                                            <li><a class="<?php if (empty(array_intersect(['employee-report'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>employee-report" href="<?= base_url(); ?>employee-report">Employee</a></li>
                                            ...
                                            <li><a class="<?php if (empty(array_intersect(['subscription-report'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>subscription-reports" href="<?= base_url(); ?>subscription-report">Subscription</a></li>
                                            ...
                                            <li><a class="<?php if (empty(array_intersect(['product-booking-list'], $feature_slugs))) {
                                                                echo 'blurred ';
                                                            } ?>product-booking-lists" href="<?= base_url(); ?>product-booking-list">All Product Bookings</a></li>
