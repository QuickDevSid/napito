                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="tm_width_2" style="width:20%;text-align:center;"><?=($single_services_result->service_price != "") ? $single_services_result->service_price : '-'; ?></td>
                    </tr> 
                    <?php }} ?>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">
                        <?=$single_payment_details->total_service_price;?>
                      </td>
                    </tr>
                    <?php if($single_payment_details->products != "" && $single_payment_details->products != null && $single_payment_details->total_product_price != '0' && $single_payment_details->total_product_price != '0.00'){ ?>
                    <tr class="tm_gray_bg ">
                    ...
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$single_payment_details->package_amount; ?></td>
                    </tr>
                    <?php } ?>
                    ...
                    <?php if ($m_service_discount > 0) { ?>
                      <tr class="tm_gray_bg" style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$m_service_discount; ?></td>
                      </tr>
                    <?php } ?>
                    <?php if ($m_product_discount > 0) { ?>
                      <tr class="tm_gray_bg " style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$m_product_discount; ?></td>
                      </tr>
                    <?php } ?>
                    <?php if ($offer_discount > 0) { ?>
                      <tr class="tm_gray_bg " style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$offer_discount; ?></td>
                      </tr>
                    <?php } ?>
                    <?php if ($coupon_discount > 0) { ?>
                      <tr class="tm_gray_bg " style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$coupon_discount; ?></td>
                      </tr>
                    <?php } ?>
                    <?php if ($gift_discount > 0) { ?>
                      <tr class="tm_gray_bg " style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$gift_discount; ?></td>
                      </tr>
                    <?php } ?>
                    <?php if ($reward_discount > 0) { ?>
                      <tr class="tm_gray_bg " style="background: #0080002e;">
                        ...
                        <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$reward_discount; ?></td>
                      </tr>
                    <?php } ?>
