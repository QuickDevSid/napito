                                    ...
                                    <div class="">
                                        <div class="row top-section">
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <select class="form-control get_attendance chosen-option" name="employee" id="employee">
                                                    <option value="">Select Employee</option>
                                                    <?php if(!empty($employee)){ 
                                                        foreach($employee as $employee_result){?>
                                                        <option value="<?=$employee_result->id?>" <?php if(isset($_GET['employee']) && $_GET['employee'] == $employee_result->id){?>selected="selected"<?php }?>><?=$employee_result->full_name?> <?=$employee_result->designation_name != "" ? ' [' . $employee_result->designation_name . ']' : ''; ?></option>
                                                    <?php }}?>
                                                </select>
