                                ...
                                <form method="post" name="customer_form" id="customer_form" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="coupan_code" id="coupan_code" value="<?php if (!empty($single_setup_coupn)) { echo $single_setup_coupn->coupan_code; } ?>" placeholder="Enter coupon code ">
