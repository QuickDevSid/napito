...
<script>
    function showTemplate() {
        ...
        const templateName = "<?= Promo_Booking_Temp; ?>";

        const message = `
            <p><strong>No More Waiting – Book Your Appointment at ${salonName} Instantly!</strong></p>
            <p>Skip the call – now you can book directly through the Napito App and unlock exclusive offers and discounts!</p>
            <p>📲 Download the Napito App Now:<br>
            <a href="https://play.google.com/store/apps/details?id=com.quick.napito2" target="_blank">
            https://play.google.com/store/apps/details?id=com.quick.napito2</a></p>
            <p><strong>How to Register:</strong><br>
            Enter your mobile number and verify with the OTP<br>
            Fill in your details:<br>
            &emsp;– Gender<br>
            &emsp;– Name<br>
            &emsp;– Birthday<br>
            &emsp;– Anniversary</p>
            <p>📍 Scan the QR Code or enter this Store Code: <strong>${storeCode}</strong></p>
            <p>📞 For more info, contact: <strong>${contactInfo}</strong></p>
