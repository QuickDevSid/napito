...
<script>
    ...
    $(document).ready(function() {
        ...
        function showTemplate() {
            ...
            const templateName = "<?= Trying_Booking_Temp; ?>";

            const message = `
                <p>Hello <strong>${customerName}</strong>,</p>
                <p>We noticed you previously attempted to book an appointment, but your selected time wasn’t available.</p>
                <p>A recent cancellation has opened up the following slot:</p>
                <p>📆 <strong>Date:</strong> ${date} &nbsp;&nbsp; ⏰ <strong>Time:</strong> ${timeSlot}</p>
                <p>Please reschedule your appointment from Napito App.</p>
                <p>For any assistance, please call on <strong>${salonContact}</strong>.</p>
