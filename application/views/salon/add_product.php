...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="row">
            ...
            <!-- <div class="dropdown top-btn-btn setting_btn">
            ...
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    <li class="tab-pane <?php if($this->uri->segment(2) == "" && !isset($_GET['use_this']) && !isset($_GET['pending_tab'])){?>active<?php }?>" id="tab_1">
                    ...
                    <li class="tab-pane <?php if(isset($_GET['pending_tab'])){?>active<?php }?>" id="tab_4">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane <?php if($this->uri->segment(2) == "" && !isset($_GET['use_this']) && !isset($_GET['pending_tab'])){?>active<?php }?>" id="1">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h3>My Product</h3>
                                ...
                                <?php if(!empty($product_category_list)) {
                                    foreach($product_category_list as $product_category_list_result){ 
                                       ?>
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-6 category_row_box">
                                            <div class="row">
				...
				<div class="tab-pane <?php if(isset($_GET['pending_tab'])){?>active<?php }?>" id="4">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
								...
								<table style="width: 100%;"  id="example" class="table table-striped responsive-utilities jambo_table">
									...
									<?php if(!empty($pending_products)){
										...
										foreach ($pending_products as $pending_products_result) {
                                            if($pending_products_result->discount_in == '0'){
                                                $discount_text = $pending_products_result->discount . '%';
                                            }elseif($pending_products_result->discount_in == '1'){
                                                $discount_text = 'Rs. ' . $pending_products_result->discount;
                                            }else{
                                                $discount_text = '-';
                                            }
										   ...
										   ?> 
												<tr>
													...
													<td><?=$pending_products_result->selling_price?></td> 
													<!-- <td><?=$discount_text?></td> 
													<td><?=$pending_products_result->incentive?></td>  -->
                                                    <td>
                                                        <?php 
                                                            if ($pending_products_result->product_photo != "") {
                                                                $images = explode(',',$pending_products_result->product_photo);
													...
													<td>
														<!-- <a class="btn btn-primary" href="javascript:void(0)">Pending</a> -->
                                ...
                                <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                                    <div class="row flex_wrap">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="hidden" name="is_pending_product" id="is_pending_product" value="<?php if(!empty($single_product)){ echo '0'; }else{ echo '1'; } ?>">
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
									...
									<div class="row"> -->
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Does expiry date required?<b class="require">*</b> <small>(In Product Inward)</small></label>
