    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Coupons <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
<!-- 
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_coupons_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            ...
            const minimum_amt = "{{Min. Amount}}";

            const message = `
                <p>💸 Special Offer Just for You! 💸</p>
                <p>Make a minimum purchase of ${minimum_amt} and get ${discount_text} on your next visit!</p>
                <p>Hurry—this offer is valid until ${expiryDate}.</p>
                <p>Don’t miss out!</p>
            `;
...
<script>
    $(document).ready(function() {
        ...
        $('.coupons-setup').addClass('active_cc');
    });
</script>
