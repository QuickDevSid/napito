...
table .btn-primary, table.btn-primary:hover {
            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="calender_booking_details" style="background-color: #f7f7ff;">
                        <table class="std-tbl" style="width:100%;">
                            <thead>
                        ...
                        <form method="post" name="payment_form_<?=$booking->id;?>" id="payment_form_<?=$booking->id;?>" action="<?=base_url();?>generate-bill/<?=base64_encode($booking->id);?>">
                            <div class="row">
                                <div class="col-lg-9 col_resp">
                                    <div class="calender_booking_details service_details_div service_details_box" style="background-color: #f7f7ff;height: 300px; overflow-y: auto; border: 0.5px solid #afafaf;">
                                        <table class="std-tbl" style="width:100%;">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                $service_single_count = 1;
                                                    if(!empty($booking_services)){
                                                        foreach($booking_services as $booking_services_result){
                                                            ...
                                                            if($booking_services_result->is_service_discount_applied == '1'){
                                                                $is_discount_applied = '1';
                                                                $customer_criteria = $booking_services_result->service_discount_customer_criteria;
                                                                $discount_type = $booking_services_result->discount_type;
                                                                $discount_in = $booking_services_result->discount_in;
                                                                $discount_amount_value = (float)$booking_services_result->discount_value;
                                                                $discount_applied_slab = $booking_services_result->applied_flexible_slab;   
                                                                
                                                                $service_marketing_discount_type = $booking_services_result->service_marketing_discount_type;  
                                                                
                                                                $reward_applied_slab = $booking_services_result->rewards_applied_flexible_slab;                            
                                                                $reward_received_discount = $booking_services_result->rewards_received_discount;                            
                                                                ...
                                                                if($discount_type == '1'){    //Flexible
                                                                    if($discount_in == '0'){  //percentage
                                                                        $discount_text = '<p style="color:#01a900;font-size:10px;">' . $marketing_criteria . '' . $discount_applied_slab . '% Off</p>';
                                                                    }elseif($discount_in == '1'){ //flat
                                                                        $discount_text = '<p style="color:#01a900;font-size:10px;">' . $marketing_criteria . 'Flat Rs. ' . $discount_applied_slab . ' Off</p>';
                                                                    }
                                                            ...
                                                            if($is_discount_applied == '1'){
                                                                if($service_marketing_discount_type == '1'){  //for regular customer rewards are given
                                                                    $rewards_text = '<p style="color:#01a900;font-size:10px;">' . $marketing_criteria . 'Earn ' . $reward_received_discount . ' Reward Points</p>';
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" id="booking_service_product_response_<?=$booking_services_result->id;?>">
                                                                            <div class="calender_booking_details product_details_div">
                                                                                <table class="std-tbl" style="width:100%; border: 0.5px solid #afafaf;">
                                                                                    <thead>
                                                                                        <tr style="border-bottom: 0.5px solid #afafaf;">
                                                                                            <th>Select</th>
                                                                                            <th>Product</th>
                                                ...
                                                <input type="hidden" name="single_service_original_price_<?=$booking_services_result->id;?>" id="single_service_original_price_<?=$booking_services_result->id;?>" value="<?=($booking_services_result->original_service_price != "" && $booking_services_result->original_service_price != "" && $booking_services_result->original_service_price != "0" && $booking_services_result->original_service_price != "0.00") ? $booking_services_result->original_service_price : '0.00';?>">
                                                <input type="hidden" name="service_marketing_discount_type_<?=$booking_services_result->id;?>" id="service_marketing_discount_type_<?=$booking_services_result->id;?>" value="<?=$booking_services_result->service_marketing_discount_type;?>">
                                                <input type="hidden" class="marketing_criteria_discount_text" name="service_discount_customer_criteria_<?=$booking_services_result->id;?>" id="service_discount_customer_criteria_<?=$booking_services_result->id;?>" value="<?=$booking_services_result->service_discount_customer_criteria;?>">
                                                <input type="hidden" name="service_added_from_<?=$booking_services_result->id;?>" id="service_added_from_<?=$booking_services_result->id;?>" value="<?=$booking_services_result->service_added_from;?>">
                                                <input type="hidden" name="received_discount_<?=$booking_services_result->id;?>" id="received_discount_<?=$booking_services_result->id;?>" value="<?=$booking_services_result->received_discount;?>">
                                    ...
                                    <div class="calender_booking_details service_details_div service_details_box" style="margin-top: 10px;background-color: #f7f7ff;height: 150px; overflow-y: auto; border: 0.5px solid #afafaf;">
                                        <table class="std-tbl" style="width:100%;">
                                            <thead>
                                                <tr style="background:linear-gradient(271deg, #800080, #ff69b4);border-bottom: 0.5px solid #afafaf;height: 30px;">
                                                    <th style="width:5%;">Sr. No.</th>
                                                    <th style="width:30%;">Product</th>
                                                    <th style="width:10%;">Price <small>(Per Qty.)</small></th>
                                                    <th style="width:5%;">Quantity</th>
                                                    <th style="width:5%;">Amount</th>
                                                    <th style="width:10%;">Stylist</th>
                                                    <th style="width:30%;">Select Product</th>
                                                    <th style="width:5%;"></th>
                                                </tr>
                                            </thead>
                                            <tbody id="product_purchase_details_<?=$booking->id;?>">
                                                <tr><td colspan="7" class="error"><label class="error" style="font-size:10px;">Products not selected</label></td></tr>
                                                <tr><td colspan="7">
                                                    <div style="text-align:center;">
                                                        <button type="button" title="Add Products" onclick="showProductPurchaseDiv(<?=$booking->id;?>)" data-toggle="modal" data-target="#ProductPurchaseModal_<?=$booking->id;?>" class="btn btn-primary">Add Products</button>
                                                    </div>
                                                </td></tr>
                                            </tbody>
                                        </table>                                        
                                ...
                                <input type="hidden" name="selected_product_stylist_hidden_<?=$booking->id;?>" id="selected_product_stylist_hidden_<?=$booking->id;?>" value="">
                                ...
                                <input type="hidden" id="marketing_service_discount_amount_hidden_<?=$booking->id;?>" name="marketing_service_discount_amount_hidden_<?=$booking->id;?>" value="0.00">
                                <input type="hidden" id="marketing_product_discount_amount_hidden_<?=$booking->id;?>" name="marketing_product_discount_amount_hidden_<?=$booking->id;?>" value="0.00">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12">
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input value="0" autocomplete="off" type="text" class="form-control" name="discount_in_per" id="discount_in_per" max="100" placeholder="Enter discount in %" onkeyup="setFlatDiscount(<?=$booking->id;?>)">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <label>Extra Discount<b class="require">*</b><small>(In INR)</small></label>
                                            <input value="0.00" autocomplete="off" type="text" class="form-control" name="discount_in_rs" id="discount_in_rs" placeholder="Enter discount in INR" onkeyup="setPerDiscount(<?=$booking->id;?>)">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row bill_in">
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <input type="number" class="form-control" name="adjust_amount_<?=$booking->id;?>" id="adjust_amount_<?=$booking->id;?>" placeholder="Enter Adjust Amount" value="0.00" onkeyup="calculateActualPaidAmount(<?=$booking->id;?>)">
                                            <label for="adjust_amount_<?=$booking->id;?>" generated="true" class="error" style="display:none;float:left; width:100%;">Please enter payment amount!</label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <label>Amount Round Type</label>
                                            <select class="form-control form-select" name="amount_round_type_<?=$booking->id;?>" id="amount_round_type_<?=$booking->id;?>" onchange="calculateActualPaidAmount(<?=$booking->id;?>)">
                                                <option value="Up">Up</option>
                                                <option value="Down">Down</option>
                                            </select>
                                            <label for="amount_round_type_<?=$booking->id;?>" generated="true" class="error" style="display:none;float:left; width:100%;">Please enter payment amount!</label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <label>Round Bill Amount</label>
                                            <input type="number" class="form-control" name="rounded_bill_amount_<?=$booking->id;?>" id="rounded_bill_amount_<?=$booking->id;?>" placeholder="Enter Round Bill Amount" value="0.00" readonly>
                                            <label for="rounded_bill_amount_<?=$booking->id;?>" generated="true" class="error" style="display:none;float:left; width:100%;">Please enter payment amount!</label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <label>Previous Pending Amount<b class="require">*</b></label>
                                            <input readonly value="<?=($booking->current_pending_amount != "" && $booking->current_pending_amount != null) ? $booking->current_pending_amount : '';?>" autocomplete="off" type="text" class="form-control" placeholder="Enter previous due amount">
                                        </div>
                                    </div>
                                    <div class="row bill_in">
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <label>Total Due Amount <small><i title="Including Previous Due <?=($booking->current_pending_amount != "" && $booking->current_pending_amount != null) ? 'of Rs. '.$booking->current_pending_amount : '';?>" style="font-size: 12px;margin-top: 5px;margin-left: 5px;cursor:pointer;color:#0000ffb0;" class="fas fa-info-circle"></i></small></label>
                                            <input type="number" class="form-control" name="total_due_amount_<?=$booking->id;?>" id="total_due_amount_<?=$booking->id;?>" placeholder="Enter Total Due Amount" value="<?=($booking->current_pending_amount != "" && $booking->current_pending_amount != null) ? $booking->current_pending_amount : '0.00';?>" readonly>
                                            <label for="total_due_amount_<?=$booking->id;?>" generated="true" class="error" style="display:none;float:left; width:100%;">Please enter payment amount!</label>
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            <label>Actual Paid Amount</label>
                                            <input type="number" class="form-control" name="paid_amount_<?=$booking->id;?>" min="0.00" id="paid_amount_<?=$booking->id;?>" placeholder="Enter Actual Paid Amount" value="" onkeyup="calculatePendingAmount(<?=$booking->id;?>)" <?php if($booking->booking_generated_from == '1'){ echo ''; }?>> 
                                            <!-- readonly title="Complete Payment needed for Mobile Bookings" -->
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <input readonly type="number" class="form-control" name="pending_amount_<?=$booking->id;?>" id="pending_amount_<?=$booking->id;?>" placeholder="Enter Current Pending Amount" value="">
                                        ...
                                        <div class="form-group col-lg-9 col-md-9 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="adjust_amount_remark_<?=$booking->id;?>" id="adjust_amount_remark_<?=$booking->id;?>" placeholder="Enter Adjust Amount Remark" value="">
                                            <label for="adjust_amount_remark_<?=$booking->id;?>" generated="true" class="error" style="display:none;float:left; width:100%;">Please enter payment amount!</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12" id="message_type_div_<?=$booking->id;?>" style="display:none;">
                                        ...
                                        <div class="form-group col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div class="row">
                                                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                    ...
                                                    <select class="form-control form-select payment_mode" name="payment_mode_<?=$booking->id;?>[]" id="payment_mode_<?=$booking->id;?>" data-id="<?=$booking->id;?>">
                                                ...
                                                <div class="form-group col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" min="0" class="form-control mode_amount" name="mode_amount_<?=$booking->id;?>[]" id="mode_amount_<?=$booking->id;?>" value="" placeholder="Enter Payment Mode Amount">
                                                </div>
                                                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                    <label>Transaction ID</label>
                                                    <input readonly type="text" placeholder="Enter Transaction ID transaction_id" class="form-control" name="transaction_id_<?=$booking->id;?>[]" id="transaction_id_<?=$booking->id;?>" value="">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-xs-12" style="text-align:right;">
                                            <button style="font-size:12px;" type="submit" class="btn btn-info submit_bill_button" id="save_payment_btn_<?=$booking->id;?>" name="payment_btn_<?=$booking->id;?>" value="save">Save Bill</button>
                                            <button style="padding:8px 12px" type="submit" class="btn btn-primary submit_bill_button" id="payment_btn_<?=$booking->id;?>" name="payment_btn_<?=$booking->id;?>" value="generate">Generate Bill & Share with Customer</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
...
<div class="loader_div">
    ...
    <div class="modal fade" id="ProductPurchaseModal_<?=$booking->id;?>"  tabindex="-1" aria-labelledby="ProductPurchaseLabel_<?=$booking->id;?>" aria-hidden="true">
        <div class="modal-dialog" id="order_note_dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ProductPurchaseLabel_<?=$booking->id;?>" style="display: flex; justify-content: space-between; align-items: center;">
                        <span>Add Products</span>
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="float:none !important; position:absolute;right:10px;top:10px;" onclick="closePopup('ProductPurchaseModal_<?=$booking->id;?>')">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="purchase_product_response_<?=$booking->id;?>"></div>
            </div>
        </div>
    </div>
        ...
        <script>
                    ...
                    submitHandler: function(form) {
                        ...
                        if (isValid) {
                            for(i=0;i<selectedProducts.length;i++){
                                var selectedValue = selectedProducts[i];                                
                                var product_quantity = $('#product_quantity_' + selectedValue).val();
                                if(product_quantity > 0){
                                    var selectedStockValue = $('#used_product_barcodes_' + selectedValue).val();
                                    if (selectedStockValue == "" || selectedStockValue == null || selectedStockValue.length == 0) {                            
                                        // $('#stock_selection_single_error_'+selectedValue+'_<?=$booking->id;?>').html('Please select stock product');
                                        // $('#stock_selection_single_error_'+selectedValue+'_<?=$booking->id;?>').show();
                                        // isValid = false;
                                        // $('.loader_div').hide();   
                                        // return false;
                                        isValid = true;
                                    }else{     
                                        if(product_quantity == selectedStockValue.length){
                                            $('#stock_selection_single_error_' + selectedValue + '_<?=$booking->id;?>').html('');
                                            $('#stock_selection_single_error_' + selectedValue + '_<?=$booking->id;?>').hide();
                                        }else{                          
                                            // $('#stock_selection_single_error_'+selectedValue+'_<?=$booking->id;?>').html('Total ' + product_quantity + ' stock products required');
                                            // $('#stock_selection_single_error_'+selectedValue+'_<?=$booking->id;?>').show();
                                            // isValid = false;
                                            // $('.loader_div').hide();   
                                            // return false;
                            ...
                            if (isValid) {
                                ...
                                $('.stock_selection_service_error').html('');
                                $('.stock_selection_service_error').hide();
            ...
            function setServicePrice(serviceDetailsID,bookingID){
                ...
                var single_service_original_price = parseFloat($('#single_service_original_price_' + serviceDetailsID).val());
                ...
                if ($('#service_checkbox_' + serviceDetailsID).is(':checked')) {
                    ...
                    current_total = current_total + single_service_original_price;
            ...
            function setBookingAmount(bookingID){
                ...
                marketing_product_discount_amount = parseFloat($('#marketing_product_discount_amount_hidden_' + bookingID).val());
                marketing_service_discount_amount = parseFloat($('#marketing_service_discount_amount_hidden_' + bookingID).val());
                membership_service_discount_amount = parseFloat($('#m_service_discount_amount_' + bookingID).val());
                membership_product_discount_amount = parseFloat($('#m_product_discount_amount_' + bookingID).val());
                giftcard_discount_amount = parseFloat($('#gift_discount_' + bookingID).val());
                ...
                extra_discount = parseFloat($('#discount_in_rs').val());
                payable = parseFloat($('#payable_hidden_' + bookingID).val());                
                
                $('#discount_in_rs').attr('max',(payable - coupon_discount - reward_discount - offer_discount_amount_ - marketing_service_discount_amount - marketing_product_discount_amount - membership_service_discount_amount - membership_product_discount_amount - giftcard_discount_amount));

                booking = payable - coupon_discount - reward_discount - offer_discount_amount_ - marketing_service_discount_amount - marketing_product_discount_amount - extra_discount - membership_service_discount_amount - membership_product_discount_amount - giftcard_discount_amount;
            ...
            function setGrandTotal_bill(bookingID){
                ...
                calculateActualPaidAmount(bookingID);
            }

            function calculateActualPaidAmount(bookingID){
                grand_total = parseFloat($('#grand_total_hidden_' + bookingID).val()) || 0;
                adjust_amount = parseFloat($('#adjust_amount_' + bookingID).val()) || 0;
                amount_round_type = $('#amount_round_type_' + bookingID).val();
                ...
                $('#rounded_bill_amount_' + bookingID).val(parseFloat(actual_paid_amount).toFixed(2));

                calculateTotalDueAmount(bookingID);
            }

            function calculateTotalDueAmount(bookingID){
                rounded_bill_amount = parseFloat($('#rounded_bill_amount_' + bookingID).val()) || 0;
                customer_pending_amount = parseFloat($('#customer_pending_amount_' + bookingID).val()) || 0;

                total_due_amt = rounded_bill_amount + customer_pending_amount;
                
                $('#total_due_amount_' + bookingID).val(parseFloat(total_due_amt).toFixed(2));
                $('#paid_amount_' + bookingID).val(parseFloat(total_due_amt).toFixed(2));
                $('#mode_amount_' + bookingID).val(parseFloat(total_due_amt).toFixed(2)).attr('max', parseFloat(total_due_amt).toFixed(2));

                calculatePendingAmount(bookingID);
            }

            function calculatePendingAmount(bookingID){
                total_due_amount = parseFloat($('#total_due_amount_' + bookingID).val()) || 0;
                paid_amount = parseFloat($('#paid_amount_' + bookingID).val()) || 0;
                
                pending_now = total_due_amount - paid_amount;

                $('#pending_amount_' + bookingID).val(parseFloat(pending_now).toFixed(2));

                $('#mode_amount_' + bookingID).val(parseFloat(paid_amount).toFixed(2)).attr('max', parseFloat(paid_amount).toFixed(2));
                $(`#more_payment_modes_${bookingID}`).empty('');
            ...
            function calculateTotalDiscount(bookingID){
                ...
                var marketing_product_discount_amount = 0;
                for(i=0;i<selectedProducts.length;i++){
                    var selectedValue = selectedProducts[i];   
                    var product_received_discount = parseFloat($('#product_received_discount_' + selectedValue).val());
                    var product_quantity = parseFloat($('#product_quantity_' + selectedValue).val());
                    product_received_discount = product_received_discount * product_quantity;
                    marketing_product_discount_amount += product_received_discount;
                }
                $('#marketing_product_discount_amount_hidden_' + bookingID).val(parseFloat(marketing_product_discount_amount).toFixed(2));

                var marketing_service_discount_amount = 0.00;

                $('.booking_services_' + bookingID + ':checked').each(function() {
                    var details_id = $(this).val();

                    var service_marketing_discount_type = $('#service_marketing_discount_type_' + details_id).val();
                    var service_added_from = $('#service_added_from_' + details_id).val();
                    if(service_added_from == '0'){
                        var service_discount_rewards_type = parseFloat($('#service_marketing_discount_type_' + details_id).val());
                        if(service_discount_rewards_type == '0'){
                            var service_received_discount = parseFloat($('#received_discount_' + details_id).val());
                            marketing_service_discount_amount += service_received_discount;
                        }
                    }
                });
                $('#marketing_service_discount_amount_hidden_' + bookingID).val(parseFloat(marketing_service_discount_amount).toFixed(2));

                var marketing_product_discount_amount = parseFloat($('#marketing_product_discount_amount_hidden_' + bookingID).val());
                var marketing_service_discount_amount = parseFloat($('#marketing_service_discount_amount_hidden_' + bookingID).val());
                ...
                var extra_discount = parseFloat($('#discount_in_rs').val());
                 
                total_discount = marketing_product_discount_amount + marketing_service_discount_amount + membership_service_discount_amount + membership_product_discount_amount + offer_discount_amount + coupon_discount_amount + giftcard_discount_amount + reward_discount_amount + extra_discount;
                ...
                if (marketing_service_discount_amount > 0) {
                    var uniqueValues = [];

                    $('.marketing_criteria_discount_text').each(function() {
                        var val = $(this).val().trim();
                        if (val !== "" && !uniqueValues.includes(val)) {
                            uniqueValues.push(val);
                        }
                    });
                    var firstValue = uniqueValues.length > 0 ? uniqueValues[0] : "";
                    
                    if(firstValue == '0'){
                        firstValue = 'New Client Benefits';
                    }else if(firstValue == '1'){
                        firstValue = 'Regular Client Benefits';
                    }else if(firstValue == '2'){
                        firstValue = 'Lost Client Benefits';
                    }else if(firstValue == '3'){
                        firstValue = 'Birthday Benefits';
                    }else if(firstValue == '4'){
                        firstValue = 'Anniversary Benefits';
                    }else if(firstValue == '5'){
                        firstValue = 'Products Marketing Benefits';
                    }

                    discount_details += '<p>' + firstValue + ' Discount <span class="amount" style="float: right;">' + marketing_service_discount_amount.toFixed(2) + '</span></p>';
                }
                if (marketing_product_discount_amount > 0) {
                    discount_details += '<p>Product Marketing Discount <span class="amount" style="float: right;">' + marketing_product_discount_amount.toFixed(2) + '</span></p>';
                }
                ...
                if (extra_discount > 0) {
                    discount_details += '<p>Extra Discount <span class="amount" style="float: right;">' + extra_discount.toFixed(2) + '</span></p>';
                }
        ...
        function showProductPurchaseDiv(id) {
            $.ajax({
                url: "<?= base_url(); ?>salon/Ajax_controller/get_product_purchase_ajx",
                method: 'POST',
                data: {
                    id: id,
                    'selectedProducts': selectedProducts,
                    'selected_product_stylist': $('#selected_product_stylist_hidden_' + id).val()
                },
                success: function(response) {
                    $('#purchase_product_response_' + id).html(response)
                    showPopup('ProductPurchaseModal_' + id);
                },
        ...
        function createProductRows(id){
            $('#product_purchase_details_' + id).empty();
            $.ajax({
                url: "<?= base_url(); ?>salon/Ajax_controller/get_product_purchase_rows_ajx",
                method: 'POST',
                data: {
                    id: id,
                    'selectedProducts': selectedProducts,
                    'customer': $('#customer_id_' + id).val(),
                    'selected_product_stylist': $('#selected_product_stylist_hidden_' + id).val()
                },
                success: function(response) {
                    $('#product_purchase_details_' + id).append(response);
                    setProductPrice(id);
                },
                error: function(xhr, status, error) {
                    console.error('Error fetching products:', error);
        ...
        function setProductPrice(bookingID){   
            ...
            for(var y=0;y<selectedProducts.length;y++){
                var productDetailsId = selectedProducts[y];
        ...
        function calculateRemainingAmount(bookingId) {
            let totalAmount = parseFloat($('#paid_amount_' + bookingId).val()) || 0;
            let totalEntered = 0;
            ...
            if(current_remaining > 0){
                let newRow = `
                    <div class="row payment-row" id="payment_row_${uniqueId}">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <label>Transaction ID</label>
                            <input readonly type="text" placeholder="Enter Transaction ID" class="form-control" name="transaction_id_${bookingId}[]" id="transaction_id_${uniqueId}">
                        </div>
                        <div class="form-group col-lg-1 col-md-1 col-sm-6 col-xs-12">
        ...
        function setFlatDiscount(bookingID){
            var price = $('#payable_hidden_' + bookingID).val();
        ...
        function setPerDiscount(bookingID){
            var price = $('#payable_hidden_' + bookingID).val();
