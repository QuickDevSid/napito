        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
                <h3 style="margin-left: 20px;"><b>All Purchase Product Orders</b></h3>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:0px auto;">
                    <div class="x_panel">
                        <div class="x_content">
                            <form id="make_form" name="make_form" method="get" enctype="multipart/form-data" data-parsley-validate>                                
                                <div class="row"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label for="fullname">Select Order</label>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label for="fullname">Purchase From Date</label>
                                        <input type="text" class="form-control custom_date" placeholder="Purchase From Date" name="from_date" id="from_date" value="<?php if(isset($_GET["from_date"]) && $_GET["from_date"] != "0" && $_GET["from_date"] != ""){ echo date('d-m-Y',strtotime($_GET['from_date'])); }?>">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label for="fullname">Purchase To Date</label>
                                        <input type="text" class="form-control custom_date" placeholder="Purchase To Date" name="to_date" id="to_date" value="<?php if(isset($_GET["to_date"]) && $_GET["to_date"] != "0" && $_GET["to_date"] != ""){ echo date('d-m-Y',strtotime($_GET['to_date'])); }?>">
                                    </div> 
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        <label for="fullname">Show Counter Sales?</label>
                        ...
                        <div class="x_content">
                            <span style="text-align: center;display: block;line-height: 35px;color: white;font-weight: 600;font-size: 15px;background:linear-gradient(271deg, #800080, #ff69b4);margin-bottom: 15px;" id="">Total Orders: <?=count($total); ?></span>
                            <div id="all_rows"></div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="BillModalLabel" style="display: flex; justify-content: space-between; align-items: center;">
                    <span>Generate Product Purchase Bill</span>
                </h5>                
...
<script>    
var booking_id = '<?php if(isset($_GET['booking_id']) && $_GET['booking_id'] != ""){ echo $_GET['booking_id']; }else{ echo ''; } ?>';
$(document).ready(function(){
    ...
    var counter_bookings = '<?php if(isset($_GET['counter_bookings']) && $_GET['counter_bookings'] != ""){ echo $_GET['counter_bookings']; }else{ echo ''; } ?>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                setTimeout(function() {
                    ...
                    if(booking_id != ""){
                        showBillProductGenerationPopup(booking_id);
                    }
                }, 1000);          
            },
