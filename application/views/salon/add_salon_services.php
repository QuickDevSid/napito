        ...
        <?php } else { ?>
            ...
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    <li class="<?php if($this->uri->segment(2) == ""){if(!isset($_GET['pending'])){?>active<?php }}?>" id="tab_1">
                        <a href="#1" data-toggle="tab">My Services</a>
                    </li>
                    <li id="tab_2">
                        <a href="#2" data-toggle="tab">Ready To Use</a>
                    </li>
                    <li class="<?php if($this->uri->segment(2) != ""){if(!isset($_GET['pending'])){?>active<?php }}?>" id="tab_3">
                        <a href="<?=base_url();?>add-salon-services#3" data-toggle="tab">Add Services</a>
                    </li>
                    <li id="tab_4" class="<?php if(isset($_GET['pending'])){?>active<?php }?>">
            ...
            <div class="tab-content ">
                ...
                <div class="tab-pane <?php if($this->uri->segment(2) == ""){if(!isset($_GET['pending'])){?>active<?php }}?>" id="1">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h3>My Services</h3>
                            </div>
                            <?php if(!empty($salon_service_genders)){ ?>
                                <?php 
                                    for($gender_count=0;$gender_count<count($salon_service_genders);$gender_count++){
                                        $category_head = ''; 
                                        if($salon_service_genders[$gender_count] == '0'){
                                            $category_head = 'Male'; 
                                        }elseif($salon_service_genders[$gender_count] == '1'){
                                            $category_head = 'Female'; 
                                        }else{
                                            $category_head = ''; 
                                        }
                                ?>
                                    ...
                                    <div class="x_content">
                                        <?php 
                                            $category_name_list = $this->Admin_model->get_all_gender_services_name($salon_service_genders[$gender_count]);
                                            if (!empty($category_name_list)) {
                                                    ...
                                                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-xs-6 ">
                                                        <div class="category_row_box">
                                                            ...
                                                            <div class="row category_head">
                                                                <a href="<?= base_url(); ?>salon-services-list/<?= $services_result->id ?>">
                                                                    <h4><?= $services_result->sup_category ?></h4>
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <label class="error">Categories not available</label>
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
                                <?php } else { ?>
                                    <div class="x_content">
                                        <label class="error">Salon category not available</label>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                ...
                <div class="tab-pane tab-pane <?php if($this->uri->segment(2) != ""){if(!isset($_GET['pending'])){?>active<?php }}?>" id="3">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="container">
                                    ...
                                    <form method="post" name="sub_category_form" id="sub_category_form" enctype="multipart/form-data">
                                        <div class="row row_f" >
                                            ...
                                            <div class=" form-group col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <input autocomplete="off" type="hidden" name="is_add_new" id="is_add_new" value="<?php if (!empty($single)) { echo '0'; }else{ echo '1'; } ?>">                                      
                                                <select <?php if($this->uri->segment(2) != ""){ echo 'disabled';}?> class="form-select form-control" name="gender" id="gender" onchange="fetchGenderCategories()">
                                            ...
                                            <?php if ($flag == '1') {   ?>
                                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    ...
                                                    <select style="pointer-events: none;"  class="form-control form-select" name="sub_category" id="sub_category" <?php if($this->uri->segment(2) != ""){ echo 'disabled';}?>>
                                                        <option>Select Sub Category</option>
                                                        <?php if (!empty($single)) {
                                                                if($single->subcategory_gender == '1'){
                                                                    $gender = ' - [Female]';
                                                                }elseif($single->subcategory_gender == '0'){
                                                                    $gender = ' - [Male]';
                                                                }else{
                                                                    $gender = '';
                                                                }
                                                            ?>
                                                            <option value="<?= $single->sub_category?>" <?php if (!empty($single) && $single->sub_category) { echo 'selected';} ?>><?= $single->subcategory ?>|<?= $single->subcategory_marathi ?> <?=$gender;?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Name In Marathi</label>
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Image<?php if (!empty($single)) { echo '<b class="require">*</b>'; }else{ echo ''; } ?></label>
                                                    <input <?php if($is_ready_service == '1' || !empty($single)){ echo 'disabled'; } ?> type="file"  name="category_image" id="category_image" class="form-control">
                                            ...
                                            <?php }else{?>
                                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service  Category <b class="require">*</b></label>
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Sub Category <b class="require">*</b></label>
                                                    <select class="form-control form-select" name="sub_category" id="sub_category" <?php if($this->uri->segment(2) != ""){ echo 'disabled';}?>>
                                                        <option>Select Sub Category</option>
                                                        <?php if (!empty($single)) {
                                                                if($single->subcategory_gender == '1'){
                                                                    $gender = ' - [Female]';
                                        ...
                                        <!-- </div>
                                        <div class="row"> -->
                                            <div class="form-group col-md-4 col-sm-6 col-xs-12 service_discount" style="display: none;">
                                        ...
                                        <!-- </div>
                                        <div class="row"> -->
                                        <?php if (!empty(array_intersect(['product-booking'], $feature_slugs))) { ?>
                                            <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                 ...
                                                 <option class="">Select</option>
                                                    <?php if (!empty($product_master_list)) {
                                                        $service_exp = [];
                                                            ...
                                                            <option value="<?= $product_master_list_result->id ?>" <?php if (in_array($product_master_list_result->id,$service_exp)){?>selected="selected"<?php }?>><?= $product_master_list_result->product_category_name . '' . ($product_master_list_result->product_sub_category_name != "" ? ' > ' . $product_master_list_result->product_sub_category_name : '') . '' . ($product_master_list_result->product_name != "" ? ' > ' . $product_master_list_result->product_name : ''); ?></option>
                                                        <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                        <?php } ?>
                                             ...
                                             <div class="form-group col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                                <label>Short Description </label>
                                                 <input autocomplete="off" type="text" name="short_description" id="short_description" class="form-control" placeholder="Enter Short Name" value="<?php if (!empty($single)) { echo $single->short_description; } ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                ...
                <div class="tab-pane <?php if(isset($_GET['pending'])){?>active<?php }?>" id="4">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h3>Pending Service</h3>
                            </div>
                            <div class="x_content flex_wrap">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                            <div class="service_card_box">
                                                ...
                                                <div class="service-info-div">
                                                    <h4><?= $services_result->service_name ?>|<?= $services_result->service_name_marathi; ?></h4>
        ...
        $('#sub_category_form').validate({
            ...
            rules: {
                ...
                category_image:{
                    // required: true,
                    required: function(element) {
                        return $('#old_category_image').val() == '' && $('#is_add_new').val() == '0';
                    }
                },
            },
            messages: {
