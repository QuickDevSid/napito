    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Service Repeat <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function showTemplate() {
            ...
            const templateName = "<?= Service_Repeat_Temp; ?>";

            const message = `
                <p>Hi <strong>${name}</strong>,</p>
                <p>We noticed it’s been some time since your last visit.</p>
                <p>If you're ready, you can book your next appointment at your convenience on our Napito App.</p>
