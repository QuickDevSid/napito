    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Yesterday Cancel Appointment <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_service_cancelled_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            ...
            const signature = "{{Salon Contact}}";
            const templateName = "<?= Cancel_Appointment_Temp; ?>";

            const message = `
                <p>Hello <strong>${name}</strong>,</p>
                <p>We noticed your appointment scheduled for yesterday was canceled.</p>
                <p>Please reschedule your appointment from Napito App.</p>
                <p>For any assistance, please call on <strong>${signature}</strong>.</p>
...
<script>
    $(document).ready(function() {
        ...
        $('.cancel-appointment-setup').addClass('active_cc');
    });
</script>
