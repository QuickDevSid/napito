        ...
        if(!empty($today_service_reminders)){
            foreach($today_service_reminders as $data){
                if($data->customer_phone != "" && $data->customer_phone != null && $data->customer_phone != '0000000000'){
                    ...
                    $message = "Hi " . $data->full_name . ", %0a%0aWe noticed it’s been some time since your last visit. If you're ready, you can book your next appointment at your convenience on our Napito App. For any assistance please call on " . $visit_text . ".";
                    $app_message = "Hi " . $data->full_name . ",\n\nWe noticed it’s been some time since your last visit. If you're ready, you can book your next appointment at your convenience on our Napito App. For any assistance please call on " . $visit_text . ".";
                    ...
                    $trying_booking_id = '';
                    $wp_template_data = [
                        'template_name' =>  Service_Repeat_Temp,
                        'pay_load_components' => [
                            [
                                'type' => 'body',
                                'parameters' => [
        ...
        if(!empty($bookings)){
            foreach($bookings as $data){
                ...
                if(!empty(array_intersect(['yesterday-cancel-bookings'], $feature_slugs)) && $data->customer_phone != "" && $data->customer_phone != null && $data->customer_phone != '0000000000'){
                    ...
                    // $finalNumber = '918087279032,918999459806';
                    ...
                    $type = '25';
                    $message = "Hello, " . $data->full_name . "!%0a%0aWe noticed your appointment scheduled for yesterday was canceled. Please reschedule your appointment from Napito App. For Any assistance please call on %0a" . $visit_text;
                    $app_message = "Hello " . $data->full_name . "!\n\nWe noticed your appointment scheduled for yesterday was canceled. Please reschedule your appointment from Napito App. For Any assistance please call on \n" . $visit_text;
                    $number = $finalNumber;
                    $customer = $data->customer_name;
                    $salon_id = $data->salon_id;
                    $branch_id = $data->branch_id;
                    ...
                    $trying_booking_id = '';
                    $wp_template_data = [
                        'template_name' =>  Cancel_Appointment_Temp,
                        'pay_load_components' => [
                            [
                                'type' => 'body',
                                'parameters' => [
    ...
    public function send_promo_message(){
        ...
        if(!empty($customers) && !empty($branch)){              
            if(count($customers) <= (int)$branch->current_wp_coins_balance){     
                ...
                $message = "*No More Waiting – Book Your Appointment at {$visit_text} Instantly!*%0a%0a" .
                    "Skip the call – now you can book directly through the Napito App and unlock exclusive offers and discounts!%0a%0a" .
                    "📲 Download the Napito App Now: https://play.google.com/store/apps/details?id=com.quick.napito2%0a%0a" .
                    "How to Register:%0a" .
                    "Enter your mobile number and verify with the OTP%0a" .
                    "Fill in your details:%0a" .
                    " – Gender%0a" .
                    " – Name%0a" .
                    " – Birthday%0a" .
                    " – Anniversary%0a%0a" .
                ...
                $type = '24';
                $message_send_on = '1'; //WP
                $template_name = Promo_Booking_Temp;
                $pay_load_components = [
                        [
                            'type' => 'body',
                            'parameters' => [
