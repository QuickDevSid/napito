                                ...
                                <div class="x_content">
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="error" id="expenses_name_error"></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($expense_category_list_result->status == "1"){?>
                                                        <a title="Active"  onclick="return confirm('Are you sure to inactivate this record?');" class="btn btn-light" href="<?=base_url()?>inactive/<?=$expense_category_list_result->id?>/tbl_expenses_category"><i  style="color: blue; font-size: 25px;" class="fa-solid fa-toggle-on"></i></a>  
                                                    <?php }else{?>

                                                        <a title="Inctive"  class="btn btn-light" onclick="return confirm('Are you sure to activate this record?');" href="<?=base_url()?>active/<?=$expense_category_list_result->id?>/tbl_expenses_category"><i style="font-size: 25px;" class="fa-solid fa-toggle-off"></i></a> 
                                                    <?php }?>
                                                </td>
                                                <td>
                                                	...
                                                	<a title="Edit" class="btn btn-primary" href="<?=base_url()?>add-expense-category/<?=$expense_category_list_result->id?>"><i class="fa-solid fa-pen-to-square"></i></a>	
                                                </td>
                                            </tr>
                                        <?php }}?>
                                        </tbody>
