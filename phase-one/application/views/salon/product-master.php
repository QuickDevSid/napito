                        ...
                        <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="mfg_date" id="mfg_date"
                                        value="<?php if (!empty($single)) {
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="expiry_date" id="expiry_date"
                                        value="<?php if (!empty($single)) {
...
<script>
      $(document).ready(function () {
			$('#product .child_menu').show();
			$('#product').addClass('nv active');
			$('.right_col').addClass('active_right');
			$('.product_master').addClass('active_cc');
		});
</script>
