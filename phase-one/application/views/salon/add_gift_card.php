                                ...
                                <form method="post" name="gift_form" id="gift_form" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="text" readonly class="form-control" name="gender_name" id="gender_name" value="<?php if(!empty($single_setup_gift) && $single_setup_gift->gender="0"){ echo "Male";}else{ echo "Female";}?>"> 
                                        </div>
                                        <?php  
											$final_price = 0;
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                                <div class="custom_fields_data">
                                                    ...
                                                    <input autocomplete="off" type="text" class="color_value_input" name="bg_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_gift)){echo $single_setup_gift->bg_color;}else{ echo '#bada55';} ?>" id="hexcolor"></input>
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="custom_fields_data">
                                                    ...
                                                    <input autocomplete="off" type="text" class="button_text_color_input" name="text_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_gift)){echo $single_setup_gift->text_color;}else{ echo '#000000';} ?>" id="texthexcolor"></input>
