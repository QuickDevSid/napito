        ...
        <div class="row">
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    ...
                    <li>
                        <a class="<?php if(empty(array_intersect(['employee_incentive_master'], $feature_slugs))) { echo 'blurred '; }?>" href="<?=base_url()?>employee_incentive_master" >Empolyee Incentive</a>
                    </li>
                        ...
                        <div style="float:right;">
                          <label class="next_step">1/8</label>
                            ...
                            <?php if(!empty($designation)){ foreach($designation as $designation_result){ ?>
                              <div class="radio-item"><input class="next-step" name="staff_type" id="radio<?=$designation_result->id;?>" value="<?=$designation_result->id;?>" type="radio" <?php if (!empty($single) && $single->designation == $designation_result->id) {echo "checked";} ?>><label for="radio<?=$designation_result->id;?>"><?=$designation_result->designation;?></label></div>
                            <?php }}else{ ?>
                              <div class=""> 
                        ...
                        <div class="row">
                          <div class="col-lg-12" style="text-align:right;">
                            <label class="next_step">5/8</label>
                              ...
                              <div class="row" style="<?php if(empty($upcoming_appointments)){ echo 'display:block;'; }else{ echo 'display:none;'; } ?>"> 
                                  <!-- <div class="form-group col-md-8 col-sm-6 col-xs-12 service_name_validation">
                                      <label>Select Service <b class="require">*</b></label>
                                      <select class="form-select form-control chosen-select fifth_validate" name="service_name[]" id="service_name" multiple> 
