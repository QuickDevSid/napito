...
.load_more_box .btn-info{
    margin-top: 30px;
    background: #96c2ff;
    color: #000;
    border: 1px solid #5999f1;
    font-weight: 600;
}
.arrow_btn:active{
    box-shadow:none;
            ...
            <div class="row">
                <div class="col-md-12 col-sm-4 col-xs-12" style="margin:0px auto;">
                    <div class="x_panel">
                            ...
                            <form id="make_form" name="make_form" method="get" enctype="multipart/form-data" data-parsley-validate>                                
                                <div class="row"> 
                                    ...
                                    <div class="col-xs-2 form-group">
                                        ...
                                        <input style="height: 25px !important;" <?php if(isset($_GET['is_app']) && $_GET['is_app'] == 'on'){ echo 'checked'; } ?> type="checkbox" name="is_app" id="is_app" class="dashboardToggle">                               
                                    </div>                                          
                                </div>                                            
                        ...
                        <div class="x_content">
                            <span style="text-align: center;display: block;line-height: 35px;color: #0052cc;font-weight: 600;font-size: 15px;background-color: #2f4cdd3b;margin-bottom: 15px;" id="">Total Bookings: <?=count($total); ?></span>
                            <div id="all_rows"></div>
...
<div class="modal fade" id="detailsModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.62);">
    <div class="modal-dialog" style="margin-top:150px;width:1000px;">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="ServiceRescheduleModal" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.62);">
    <div class="modal-dialog" style="margin-top:175px;width:1050px;">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="BookingEditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.62);z-index: 1025 !important;">
    <div class="modal-dialog" style="margin-top:165px;width:1200px;">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="bookingNoteModal" style="background-color: rgba(0, 0, 0, 0.62);" tabindex="-1" aria-labelledby="noteModalLabel" aria-hidden="true">
    <div class="modal-dialog" id="order_note_dialog" style="margin-top:125px;width:500px;">
        <div class="modal-content">
            <div class="modal-header">
...
<script>  
    ...
    var service = '<?php if(isset($_GET['service']) && $_GET['service'] != ""){ echo $_GET['service']; }else{ echo '0'; } ?>';
    var stylist = '<?php if(isset($_GET['stylist']) && $_GET['stylist'] != ""){ echo $_GET['stylist']; }else{ echo '0'; } ?>';
    var status = '<?php if(isset($_GET['status']) && $_GET['status'] != ""){ echo $_GET['status']; }else{ echo ''; } ?>';
    var is_app = '<?php if(isset($_GET['is_app']) && $_GET['is_app'] != ""){ echo $_GET['is_app']; }else{ echo ''; } ?>';
