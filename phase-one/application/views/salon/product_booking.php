...
<style>
    ...
    .row.timeslot_row::-webkit-scrollbar {
    width: 8px;
}
.row.timeslot_row::-webkit-scrollbar-thumb:hover {
    background: #003f87;
}
.row.timeslot_row::-webkit-scrollbar-thumb {
    background: #0056d1;
}
.row.timeslot_row::-webkit-scrollbar-track {
    background: #f1f1f1;
}
...
.category_services_box::-webkit-scrollbar {
    width: 8px;
}

.category_services_box::-webkit-scrollbar-track {
    background: #f1f1f1;
}

.category_services_box::-webkit-scrollbar-thumb {
    background: #0056d1; /* Changed color to #0056d1 */
}

.category_services_box::-webkit-scrollbar-thumb:hover {
    background: #003f87; /* Adjusted hover color if needed */
}
    .mem-tooltip{
        width: 280px;
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <!-- side bar customer info -->
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <div class="row" id="customer_info_div" style="display:none;">
                                <div class="form-group col-md-12 col-sm-6 col-xs-12" id="not_member_div">
                                        ...
                                        <div class="client-history">
                                            <div id="exTab2" class="container">
                                                ...
                                                <div class="tab-content" style="padding: 5px;">
                                                    ...
                                                    <div class="tab-pane customer_note" id="customer_notes" style="color: #73879C;display: flex;flex-direction: column-reverse;justify-content: center;align-items: center;gap: 15px;">
                                                    </div>
                            ...
                            <div class="row" id="customer_info_empty_div" style="display:block;">
                                <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                    <img src="<?= base_url(); ?>admin_assets/images/no_data/no_data.png" width="150px">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- billing section -->
                <div class="col-md-4 col-sm-12 col-xs-12" id="pricing_details_div" style="display:block;">
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">               
                                        <select class="form-control chosen-select" id="employee" name="employee">   
                                            ...
                                            <?php if(!empty($stylists)){ foreach($stylists as $employee_result){ ?>
                                                <option value="<?=$employee_result->id;?>" <?php if(!empty($single_booking) && $single_booking->stylist_id == $employee_result->id){ echo 'selected'; }else{ if(isset($_GET['stylist']) && $_GET['stylist'] == $employee_result->id){ echo 'selected'; }} ?>><?=$employee_result->full_name;?></option>
                                            <?php }} ?>
                                        </select>
                                        <label for="employee" style="display:none;" generated="true" class="error">Please select stylist!</label> 
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <input readonly type="text" class="form-control" name="booking_date" id="booking_date" placeholder="Select Booking Date" value="<?php if(!empty($single_booking) && $single_booking->booking_date != ''){ echo date('d-m-Y',strtotime($single_booking->booking_date)); }else{ echo date('d-m-Y'); }?>" onchange="validateEmergency()">
                                        <input type="hidden" name="hidden_id" id="hidden_id" value="<?php if(!empty($single_booking)){ echo $single_booking->id; } ?>">
                                    </div>
                                ...
                                <!-- <div class="row reminder_box">
                                    ...
                                    <div class="row confirm_btn_box">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <button type="submit" class="btn btn-info" style="width: 350px;" id="booking_button" name="booking_button" value="booking_button">Confirm Booking</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12" id="pricing_details_empty_div" style="display:none;">
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="container">
                                <div class="row">
...
<div  class="loader-new"></div>
    ...
    <div class="add-new-customer-main" style="display: none;">
        <div class="add-new-customer-content" style="top: 275px;">
...
<script>
            ...
            if (index < categories.length) {
                ...
                setTimeout(function() {
                    $.ajax({
                        ...
                        data: { 'category': id, 'type': type, 'selected_booking': selected_booking},
            ...
            $.ajax({
                ...
                success: function(data) {     
                    ...
                    if(order_product_history.length > 0){
                        ...
                        $('#customer_activity').append('<img src="<?= base_url(); ?>admin_assets/images/no_data/no_data.png" width="150px">');
                    }
                    ...
                    //     }
                    // }else{
                    //     $('#customer_notes').append('<img src="<?= base_url(); ?>admin_assets/images/no_data/no_data.png" width="150px">');
                    // }
                    ...
                    if(payments.length > 0){
                        ...
                        $('#customer_payments').append('<img src="<?= base_url(); ?>admin_assets/images/no_data/no_data.png" width="150px">');
                    }
    ...
    function setCustomerNote(for_customer_id){
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>salon/Ajax_controller/get_customer_details_for_booking_ajax",
            data: { 'id': for_customer_id,'order_type': '1' },
            success: function(data) {     
                var parsedData = JSON.parse(data);
                ...
                if(parsedData.customer.custom_note != "" && parsedData.customer.custom_note != null){
                    ...
                    $('#customer_notes').append('<div class="single_activity_box" style="width:95%;margin:0px auto;">' +
