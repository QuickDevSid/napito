                                        ...
                                        <div class="row top-section">
                                            ...
                                            <div class="submit_attendence">
                                                ...
                                                <?php if(isset($_GET['employee']) || isset($_GET['month']) || isset($_GET['year'])){ ?>
                                                    <a href="<?=base_url();?><?=$this->uri->segment(1);?>" class="btn btn-info" style="margin-top: 2px;padding: 10px 30px;">Reset</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade" id="attendance_modal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.62);z-index: 1025 !important;">
    <div class="modal-dialog" style="margin-top:155px;width:600px;">
