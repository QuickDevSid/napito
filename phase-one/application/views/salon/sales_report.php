                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                ...
                                <?php if(isset($_GET['daterange']) && $_GET['daterange'] != ""){ ?>
                                    <a href="<?=base_url();?><?=$this->uri->segment(1);?>?daterange=&sale_report_type=<?php if(isset($_GET['sale_report_type'])){ echo $_GET['sale_report_type']; }?>&sale_report_filter_type=<?php if(isset($_GET['sale_report_filter_type'])){ echo $_GET['sale_report_filter_type']; }?>" class="btn btn-info" style="margin-top:25px;">Reset</a>
                                <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="content new-content" id="total_sales_report_content">  
                        ...
                        <table  id="total_sales_report_table" class="table table-striped responsive-utilities jambo_table">
                            <thead>
                                <tr>
                                    <th style="text-align:center;">Total Sales</th>
                                    <th style="text-align:center;">Service Booking <i title="Including Service Products" style="cursor:pointer;color:#0000ffb0;" class="fas fa-info-circle"></i></th>
                                    <th style="text-align:center;">Product Booking</th>
                                    <th style="text-align:center;">Expenses</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <table  id="finance_report_table" class="table table-striped responsive-utilities jambo_table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th style="text-align:center;" id="total_online_sales"></th>
            ...
            if(type == '1' || type == '0'){
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#total_product_sales').text(formatNumberInIndianFormat(parseFloat(response.total_only_product_sale).toFixed(2)));
                        ...
                        if(response.total_sales - response.total_expenses >= 0){
                            ...
                            $('#total_net_profit_loss').css('background-color','#96d196');
                        }else{
