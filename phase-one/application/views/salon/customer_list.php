...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left" style="width:100%;">
            <h3>All Customers <button style="float:right;" onclick="open_customer_model()" class="btn btn-primary">Add Customer</button></h3>
        </div>
...
<div class="modal fade" id="CustomerPaymentsModal" tabindex="-1" aria-labelledby="CustomerPaymentsModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.62);">
    <div class="modal-dialog" style="margin-top:150px;width:800px;">
        <div class="modal-content">
            <div class="modal-header">
