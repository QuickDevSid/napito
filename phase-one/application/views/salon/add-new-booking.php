                        ...
                        <div class="">
                           ...
                           <?php if (!empty($single)){?>
                                ...
                                <div class="row" style="text-align: center;">
                                    <div class="col-md-12 col-sm-6 col-xs-12 customer-profile-box" name="profile_photo" id="profile_photo">
                                        <p>
                                            <?php
                                        ...
                                        <div class="">
                                            ...
                                            <div class="row a_s_d_g">
                                                <div class="service_detail_content_box" style="display: none;">
                                                    ...
                                                    <div id="service_sss">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12" id="service_price_t" class="service_price_t"></div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12 col-sm-6 col-xs-12 service_detail_content" style="display: none;">
                                                    ...
                                                    <div class="form-group col-md-12 col-sm-6 col-xs-12 service_product_and_price" style="display: none;">
            ...
            for (var i = 0; i < d_length; i++) {
                ...
                $('.a_s_d_g').append('<div class="default_service_detail_content_box default_service_' + category_id + '"><div class="row">\
                                        ...
                                        <div id="service_sss_' + category_id + '">\
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12" id="service_price_t_' + category_id + '" class="service_price_t"></div>\
                            ...
                            parsedData.forEach(function(record) {
                                ...
                                if (flag == 1) {
                                    $('#service_sss_' + record.category + '').append('<div class="row"> <div class="col-md-6 col-sm-12 col-xs-12" id="package_service_name"><input checked onclick="showServiceDetail(' + record.id + ');" class="service_name_check" type="checkbox" name="service_name_check" id="service_name_check_' + record.id + '" value="" ><div class="service_name_t" id="service_name_t">' + record.service_name + '</div></div>\
                                                        <div class="col-md-4 col-sm-12 col-xs-12" id="service_price_t" class="service_price_t"><div class="service_price_title">Rs.' + record.final_price + '</div></div>\
