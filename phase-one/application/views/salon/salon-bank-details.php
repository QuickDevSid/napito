                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"  value="<?php if (!empty($single_bank_profile)) { echo $single_bank_profile->bank_branch_name; } ?>" type="text" class="form-control" name="bank_branch_name" id="bank_branch_name"  placeholder="Enter branch name">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
