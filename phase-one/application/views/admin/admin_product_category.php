                                ...
                                <form method="post" name="product_form" id="product_form" enctype="multipart/form-data">
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_category" <?php if(isset($_GET['flag']) && base64_decode($_GET['flag']) == 'not_allowed'){ echo 'readonly'; } ?> id="product_category" value="<?php if (!empty($single)) {echo $single->product_category;} ?>" placeholder="Enter product category">
											<div id="hsn_code_error" class="error"></div>
                                        </div>
										<div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Product Category in Marathi <b class="require">*</b></label>
                                            <input type="text" class="form-control" name="product_category_marathi" <?php if(isset($_GET['flag']) && base64_decode($_GET['flag']) == 'not_allowed'){ echo 'readonly'; } ?> id="product_category_marathi" value="<?php if (!empty($single)) {echo $single->product_category_marathi;} ?>" placeholder="Enter product category in marathi">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <?php if (!empty($single)) {?>
                                              <a style="color: blue;float: right;margin-top: -63px;" target="_blank" href="<?= base_url(); ?>admin_assets/images/product_category/<?php if (!empty($single)) {echo $single->product_photo;} ?>" class="view_image">View</a>
                                            <?php } ?>  
                                        </div> 
                                    </div> 
                                    <pre></pre>
