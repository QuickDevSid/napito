										...
										<tbody>
											...
											?>
													<tr>
														...
														<td><a style="color: blue;font-family: 'FontAwesome';" href="<?= base_url(); ?>branch_payment_history?branch=<?= $gbranch_list_result->id?>">Payments</a></td>
														<td><a style="color: blue;font-family: 'FontAwesome';" href="<?= base_url(); ?>branch-gallary/<?= $gbranch_list_result->id?>">Add Gallary</a></td>
														<td> 
