                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <select type="text" class="form-control chosen-select" name="product_category" id="product_category">
                                                ...
                                                ?>
                                                <option value="<?=$category_result->id;?>" <?php if(!empty($single) && $category_result->id == $single->product_category){ echo 'selected'; }?>><?=$category_result->product_category.'|'.$category_result->product_category_marathi;?></option>
                                                <?php }} ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Product Sub-Category <b class="require">*</b></label>
                                            <input type="text" class="form-control" name="product_sub_category" id="product_sub_category" value="<?php if (!empty($single)) {echo $single->product_sub_category;} ?>" placeholder="Enter product sub category">
