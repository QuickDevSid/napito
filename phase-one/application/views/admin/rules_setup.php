						...
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									...
									<input type="radio" class="form-select " name="availability_mode" id="availability_mode_one" value="1" <?php if(!empty($single_rules) && $single_rules->availability_mode == "1"){?>checked="checked"<?php }?>><span> Basic (Will check available stylists and their available time)</span>    
									 </div> 
							</div>  
