                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="common_description">
                                                        ...
                                                        <textarea type="text" class="form-control full-featured-non-premium" name="description" id="description" placeholder="Enter description"><?php if(!empty($single)){ echo $single->description; }?></textarea>
                                                        <div class="error" id="facility_name_error"></div>
										            </div>
                                                </div>
                                            </div>
