                    ...
                    <div class="container">
                        <form method="post" name="customer_form" id="customer_form" enctype="multipart/form-data">
                            ...
                            <div class="row" style="margin-top:25px;">
                                <div class="form-group col-lg-12" id="subs_details_div">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6" id="current_details_div">
                                    <table class="table" border="1">
                                        <tbody>
                                            <tr>
                                ...
                                <div class="form-group col-lg-6" id="new_details_div">
                                    <table class="table" border="1">
                                        <tbody>
                                            <tr>
