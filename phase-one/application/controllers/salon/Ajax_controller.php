					...
					<a style="color:black;" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_<?=$data->id;?>" href="#collapse_<?=$data->id;?>" onclick="changeCSS(<?=$data->id;?>)">
						<div class="row" style="display:flex;justify-content:space-between; align-items:center;">
							...
							<div class="col-lg-8">	
								<div class="row" >
									<div class="col-lg-4">
										<p style="font-size: 15px;color: #2f4cdd;"><b>Customer: <?=$data->full_name;?></b></p>
									</div>
									<div class="col-lg-8">
							...
							?>
										<a style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" title="Edit Booking" id="edit_button<?=$data->id;?>" onclick="showBookingEditPopup(<?=$data->id;?>)" data-toggle="modal" data-target="#BookingEditModal" class="btn btn-primary event-action-button"><i style="font-size: 15px;color: black;" class="fas fa-pencil"></i></a>
							<?php	
								// }
								if ($data->payment_status == '0' && ($data->booking_status === '1' || $data->booking_status === '3' || $data->booking_status === '4')) {                    
									echo '<button type="button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn btn-primary" id="complete_button" onclick="showCompletePopup('.$data->id.')" data-toggle="modal" data-target="#ServiceCompleteModal"><i style="color:green;font-size: 20px;" class="fas fa-check"></i></button>';
									if(date('Y-m-d H:i:s') <= $allowed_cancel_time){
										echo '<button type="button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn btn-primary" id="cancel_button" onclick="showCancelPopup('.$data->id.')" data-toggle="modal" data-target="#ServiceCancelModal"><i style="color:red;font-size: 20px;" class="fas fa-times"></i></button>';
									}
								}        
								if ($data->payment_status == '0' && ($data->booking_status === '1' || $data->booking_status === '3' || $data->booking_status === '4')) {                    
							...
							?>	
									<!-- <a class="btn btn-primary event-action-button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" title="Generate Bill" type="button" id="bill_generate_button" onclick="showBillGenerationPopup('<?=$data->id;?>')" data-toggle="modal" data-target="#BookingBillModal"><i style="font-size: 15px;color: black;" class="fas fa-file-invoice"></i></a>	 -->
									<a class="btn btn-primary event-action-button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" title="Generate Bill" type="button" id="bill_generate_button" href="<?=base_url();?>bill-setup/<?=base64_encode($data->id);?>"><i style="font-size: 15px;color: black;" class="fas fa-file-invoice"></i></a>	
							<?php 
									}
								} 
								if($data->booking_status == "5" && $data->payment_status == "1"){
							?>
									<a style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn btn-primary event-action-button" target="_blank" href="<?=base_url();?>booking-print/<?=base64_encode($data->id);?>/<?=base64_encode($data->booking_payment_id);?>?list" title="Receipt"><i style="font-size: 15px;color: black;" class="fas fa-receipt"></i></a>
							<?php 
								} 
								echo '<button type="button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn btn-primary" id="note_button" onclick="showBookingNotesDiv('.$data->id.')" data-toggle="modal" data-target="#bookingNoteModal"><i style="color:black;font-size: 20px;" class="fas fa-sticky-note"></i></button>'; 
							?>
				...
				<h4 class="panel-title">
					<a style="color:black;" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_<?=$data->id;?>" href="#collapse_<?=$data->id;?>" onclick="changeCSS(<?=$data->id;?>)">
						<div class="row" style="display:flex;justify-content:space-between; align-items:center;">
							...
							<?php if(!empty($booking_review) && $booking_review->description != ""){ ?>
								<a style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" title="Customer Review" onclick="showPopup('BookingReviewModal_<?=$booking_review->id;?>')" data-toggle="modal" data-target="#BookingReviewModal_<?=$booking_review->id;?>" class="btn btn-primary event-action-button"><i style="font-size: 15px;color: black;" class="fas fa-comment-dots"></i></a>
							<?php } ?>
							<?php
								if ($data->payment_status == '0') {
							...
							?>
										...
										<a style="margin-right:10px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" title="Add Extra Products" id="edit_button<?=$data->id;?>" href="<?=base_url();?>product-booking?customer=<?=$data->customer_name;?>&booking_id=<?=$data->id;?>"><i style="font-size: 15px;color: black;" class="fas fa-pencil"></i></a>
							<?php
									// }
								}
							?>
							...
							?>
								<a style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn" target="_blank" href="<?=base_url();?>product-booking-print/<?=base64_encode($data->id);?>/<?=base64_encode($booking_payments_result->id);?>?list" title="Receipt"><i style="font-size: 15px;color: black;" class="fas fa-receipt"></i></a>
							<?php }} ?>
							</div>
						</div>
				</h4>
...
public function get_employee_attendance_list_ajx(){
	...
	if(!empty($document)){
		...
		foreach($document as $print){
			...
			$action = '';
			if($print->punch_out == ''){
				$action = '<button type="button" style="margin-right:0px;background-color:transparent !important; border:none;outline:none; box-shadow:none;" class="btn btn-primary" id="cancel_button" onclick="setPunchOut('.$print->id.')" data-toggle="modal" data-target="#myModal" title="Set Punch Out"><i style="color:grey;font-size: 20px;" class="fas fa-clock"></i></button>';
			}
			$sub_array[] = $action;
			$data[] = $sub_array; 
		}
