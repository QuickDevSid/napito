                        ...
                        <div class="container">
                            <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control chosen-select" name="sup_catagory"
                                        id="sup_catagory">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sub_catagory" id="sub_catagory"
                                        value="<?php if (!empty($single)) {
                                            echo $single->sub_catagory;
                                        } ?>"
                                        placeholder="Enter sub catagory">
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" id="addreminder" name="add-reminder" onclick="myFunction()">
                                    <label for="addreminder">Do Want to add a Third Category?</label><br>
                                        <input type="text" style="display: none;" class="form-control" name="third_catagory" id="third_catagory"
                                        value="<?php if (!empty($single)) {
                                            echo $single->third_catagory;
                                        } ?>"
                                        placeholder="Enter third catagory">    
                                </div>
                                <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($sub_catagory_list_result->status == "1") { ?>
                                                    <a title="Active"
                                                        ...
                                                        class="btn btn-light"
                                                        href="<?= base_url() ?>inactive/<?= $sub_catagory_list_result->id ?>/tbl_service_subcategory"><i
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <a title="Inctive" class="btn btn-light"
                                                        ...
                                                        href="<?= base_url() ?>active/<?= $sub_catagory_list_result->id ?>/tbl_service_subcategory"><i
                                            ...
                                            <td>
                                                <a title="Delete" class="btn btn-danger"
                                                    ...
                                                    href="<?= base_url() ?>delete/<?= $sub_catagory_list_result->id ?>/tbl_service_subcategory"><i
                                                        class="fa-solid fa-trash"></i></a>

                                                <a title="Edit" class="btn btn-primary"
                                                    href="<?= base_url() ?>add-sub-catagory/<?= $sub_catagory_list_result->id ?>"><i
...
<script>
    $(document).ready(function () {
        ...
        $('#master_form').validate({
            ...
            messages: {
                sup_catagory: {
                    required: "Please enter sup catagory",
...
<script>
function myFunction() {
  var checkBox = document.getElementById("addreminder");
  var text = document.getElementById("third_catagory");
