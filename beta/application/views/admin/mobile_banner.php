                                    ...
                                    <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <input style="height: 50px;border: 1px solid #DDE2E8;" type="file" accept=".png,.jpg.jpeg" class="form-control" name="banner[]" id="banner" multiple>
                                                <input style="height: 50px;border: 1px;" type="hidden" class="form-control" name="old_banner" id="old_banner" value="<?php if($single != ""){ echo $single; }?>">
