...
<style>
	...
	.DTFC_LeftHeadWrapper {
		...
		/* Set background color for fixed columns header */
	}
	.x_title h2 {
		margin: 5px 0px 6px}
	.label{
	...
	.DTFC_LeftBodyWrapper {
		background-color: #ffffff;
		/* Set background color for fixed columns */
	}
	...
	.DTFC_LeftBodyWrapper td {
		...
		z-index: 1;
		background-color: #ffffff;
		/* Set background color for fixed column data */
	}
	...
	.dataTables_scrollBody td:not(.DTFC_LeftBody) {
		...
		/* Set background color for scrolling columns */
	}
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:0px auto;">
				<div class="x_panel">
					...
					<div class="x_content">
						<form class="row" id="make_form" name="make_form" method="get" enctype="multipart/form-data" data-parsley-validate>
