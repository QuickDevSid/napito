                                    ...
                                    <table class="table table-striped" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?');" href="<?=base_url()?>admin_delete/<?=$facility_list_result->id?>/tbl_facility_master"><i class="fa-solid fa-trash"></i></a>	
