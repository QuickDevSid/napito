    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Pending Service <?=!empty($single) ? '<small>for ' . $single->branch_name . ', ' . $single->salon_name . '</small>' : '-'; ?></h3>
            </div>
