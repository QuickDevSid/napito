            ...
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    ...
                    <li class="<?php if($this->uri->segment(2) != ""){?>active<?php }?>" id="tab_3">
                        <a href="#3" data-toggle="tab">Add Services</a>
                    </li>
                    <li id="tab_4">
                            ...
                            <div class="x_content">
                                <div class="container">
                                    ...
                                    <form method="post" name="sub_category_form" id="sub_category_form" enctype="multipart/form-data">
                                        <div class="row">
                                            <?php if (!empty($single) && $single->service_id != 0)
                                                
                                            {?>
                                                
                                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                    <label>Select Hello<b class="require">*</b></label>
                                                    <select style="pointer-events: none;"  class="form-control form-select" name="sup_category" id="sup_category" readonly>
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    ...
                                                    <select style="pointer-events: none;" readonly class="form-control" name="sub_category" id="sub_category">
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    ...
                                                    <input readonly autocomplete="off" type="text" name="service_name" id="service_name" class="form-control" placeholder="Enter Service Name" value="<?php if (!empty($single)) { echo $single->service_name; } ?>">
                                                </div>
                                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Name In Marathi<b class="require">*</b></label>
                                                    <input readonly autocomplete="off" type="text" class="form-control" name="service_name_marathi" id="service_name_marathi" value="<?php if (!empty($single)) { echo $single->service_name_marathi; } ?>" placeholder="Enter service name in marathi">
                                                </div>
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Image<b class="require">*</b></label>
                                                    <input readonly style="pointer-events: none;"  type="file"  name="category_image" id="category_image" class="form-control">
                                                    <input readonly type="hidden"  name="old_category_image" id="old_category_image" value="<?php if (!empty($single)) {echo $single->category_image;} ?>">
                                                    <?php if (!empty($single)) {?>
                                            ...
                                            <?php }else{?>
                                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                    ...
                                                    <select class="form-control chosen-select form-select  " name="sup_category" id="sup_category">
                                                        <i class="fa fa-chavron-down"></i>
                                                        <option>Select Category</option>
                                                        <?php if (!empty($sup_category)) {
                                                            foreach ($sup_category as $sup_category_result) { ?>
                                                  ...
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Name <b class="require">*</b></label>
                                                    <input autocomplete="off" type="text" name="service_name" id="service_name" class="form-control" placeholder="Enter Service Name" value="<?php if (!empty($single)) { echo $single->service_name; } ?>">
                                                </div>
                                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Name In Marathi<b class="require">*</b></label>
                                                    <input autocomplete="off" type="text" class="form-control" name="service_name_marathi" id="service_name_marathi" value="<?php if (!empty($single)) { echo $single->service_name_marathi; } ?>" placeholder="Enter service name in marathi">
                                                </div>
                                                  <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Service Image<b class="require">*</b></label>
                                            ...
                                            <div class="form-group flexible_discount col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="form-group col-md-4 col-sm-4 col-xs-12 service_discount" style="display: none;">
                                                ...
                                                <div id="service_discount_error error"></div>
                                            </div>
                                            <div class="form-group col-md-4 col-sm-4 col-xs-12 reward_point" style="display: none;">
                                                ...
                                                <input readonly autocomplete="off" value="<?php if (!empty($single)) {echo $single->reward_point; } ?>" type="text" name="reward_point" id="reward_point" class="form-control" placeholder="Reward Point">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                 ...
                                                 <option class="">Select</option>
                                                    <?php if (!empty($product_master_list)) {
                                                        $service_exp = [];
                                                            ...
                                                            <option value="<?= $product_master_list_result->id ?>" <?php if (in_array($product_master_list_result->id,$service_exp)){?>selected="selected"<?php }?>><?= $product_master_list_result->product_name ?></option>
                                                        <?php }
                                                    } ?>
                                                </select>
                                            </div>
                                              ...
                                              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <textarea type="text" class="full-featured-non-premium" name="service_description" id="service_description"  cols="30" rows="10" value="<?php if (!empty($single)) {echo $single->service_description; } ?>" placeholder="Enter service description"></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                       ...
                                       ?>
                                        ...
                                        <div class="popup" data-popup="popup-<?=$services_result->id?>">
                                            <div class="popup-inner">
                                                ...
                                                <a class="popup-close" data-popup-close="popup-<?=$j?>" href="#">x</a>
                                            </div>
                                        </div>
