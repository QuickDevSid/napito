...
<style>
    ...
    .resc_service_timeslots::-webkit-scrollbar-thumb {
        background: #0056d1;
        /* Changed color to #0056d1 */
    }

    .resc_service_timeslots::-webkit-scrollbar-thumb:hover {
        background: #003f87;
        /* Adjusted hover color if needed */
    }
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:0px auto;">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <span style="text-align: center;display: block;line-height: 35px;color: var(--white);font-weight: 600;font-size: 15px;background:linear-gradient(135deg, #f05dae, #cf42a0);margin-bottom: 15px;" id="">Total Bookings: <?= count($total); ?></span>
                        <div id="all_rows"></div>
