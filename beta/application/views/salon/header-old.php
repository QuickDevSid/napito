...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;500;600;700&display=swap" rel="stylesheet">
    ...
    <link href="<?= base_url() ?>salon_assets/css/work-shedule.css">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="<?= base_url(); ?>add-gallary">Add Gallary</a></li>
                                ...
                                <li><a><i class="fa-brands fa-servicestack nav-icon"></i><b class="nav-title">Service
                                    ...
                                    <ul class="nav child_menu" style="display: none">
                                          ...
                                          <li><a href="<?= base_url(); ?>add-sup-catagory">Add Catagory</a></li>
                                        <li><a href="<?= base_url(); ?>add-sub-catagory"> Add Sub Catagory</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a><i class="fa-solid fa-graduation-cap nav-icon"></i><b class="nav-title">Student Management</b><span class="fa fa-chevron-down down-icon"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                ...
                                <li><a><i class="fa-solid fa-podcast nav-icon"></i><b class="nav-title">Expense Management</b><span class="fa fa-chevron-down down-icon"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="<?= base_url(); ?>add-expense-category">Add Expense category</a></li>
