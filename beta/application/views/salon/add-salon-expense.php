						...
						<form name="add_student" id="add_student" autocomplete="off" method="POST"
							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									...
									<input autocomplete="off" id="given_to" name="given_to" type="text" class="form-control" placeholder="Given To" value="<?php if (!empty($single)) {
																																								echo $single->given_to;
																																							} ?>">
								</div>
							</div>
							<div class="row">
								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									...
									<input autocomplete="off" readonly id="expense_date" name="expense_date" type="text" class="form-control" placeholder="DD/MM/YYYY" value="<?php if (!empty($single) && $single->expense_date != '') {
							...
							<div class="row" style="margin-top:10px;">
								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									...
									<input autocomplete="off" id="expense_remark" name="expense_remark" type="text" class="form-control" placeholder="Enter Notes" value="<?php if (!empty($single)) {
																																												echo $single->expense_remark;
																																											} ?>">
								</div>

								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									<label for="parents_name">Expense Amount (In Rupees)<b class="require">*</b></label>
									<input autocomplete="off" id="expense_amount" name="expense_amount" type="text" class="form-control total_amount" placeholder="Enter expense Amount" value="<?php if (!empty($single)) {
