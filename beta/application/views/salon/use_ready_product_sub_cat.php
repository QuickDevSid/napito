                            ...
                            <tbody>
                                <?php 
									if(!empty($sub_categories)){
										$i=1;
                                        foreach($sub_categories as $sub_categories_result){
                                ?>
                                <tr>
                                    <td scope="row"><?=$i++?></td>
                                    <td><?=$sub_categories_result->product_sub_category?></td>
                                    <td>
                                        <!-- <a href="<?=base_url();?>use_ready_product_cat/<?=$this->uri->segment(2);?>/<?=$sub_categories_result->id;?>" class="btn btn-primary" data-popup-open="popup-1">Set Price</a> -->
                                        <a href="<?=base_url();?>use_ready_product_cat/<?=$this->uri->segment(2);?>/<?=$sub_categories_result->id;?>" class="btn btn-primary">Set Price</a>
                                    </td>
                                </tr>
                            <?php }}?>
