        ...
        <div class="row">
            ...
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    <li class="tab-pane <?php if(!isset($_GET['use_this'])){?>active<?php }?>" id="tab_1">
                        <a href="#1" data-toggle="tab">Membership List</a>
                    </li>
                    <li class="tab-pane" id="tab_2">
                        <a href="#2" data-toggle="tab">Ready to Use Membership</a>
                    </li>
					<?php if(isset($_GET['use_this']) && $_GET['use_this'] != ""){?>
                    <li class="tab-pane" id="tab_3">
                        <a href="#3" data-toggle="tab">Membership Setup</a>
                    </li>
					<?php }?>
                </ul><br>
            </div>
            ...
            <div class="tab-content">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table" style="width:100%;">
                                            <thead>
                                                <tr class="headings">
                                                    ...
                                                    <th class="status-column-hidden">Memebership Button</th> 
                                                ...
                                                <tbody>
                                                <?php 
												$added_membership = array();
												if(!empty($membership_list)){
                                                    $i=1;
                                                        foreach($membership_list as $membership_list_result){
															$added_membership[] = $membership_list_result->membership_id;
                                                            $active_customers = $this->Salon_model->get_active_salon_memberships_customers($membership_list_result->id);
                                                ?>
                                                <tr>
                                                    <td scope="row"><?=$i++?></td>
                                                    ...
                                                    <?php if($membership_list_result->discount_in == 0): ?>
                                                        ...
                                                        <td><?php 
                                                                    if (!empty($membership_list_result->product_discount)) {
                                                                        echo $membership_list_result->product_discount . '%';
                                                                    } else {
                                                                        echo '-'; 
                                                                    }
                                                                ?>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                if (!empty($membership_list_result->product_discount)) {
                                                                    echo 'Rs. ' . $membership_list_result->product_discount;
                                                                 } else {
                                                                     echo '-'; 
                                                                }?>
                                                        </td>
                                                    ...
                                                    <?php if(empty($active_customers)){ ?>
                                                        ...
                                                        <a title="Edit" class="btn btn-success" href="<?=base_url()?>add-membership?use_this=1&edit=<?=$membership_list_result->id?>"><i class="fa-solid fa-pen-to-square"></i></a>   
                                                    <?php }else{ ?>
                                                        Membership currently active for customers
                                                    <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php }}?>
			   ...
			   <div class="tab-pane" id="2">
                                ...
                                <div class="row">
                                    ...
                                    <table id="example1" class="table table-striped responsive-utilities jambo_table" style="width:100%;">
                                            <thead>
                                                ...
                                                <tbody>
                                                <?php if(!empty($ready_membership)){
														$i=1;
                                                        foreach($ready_membership as $ready_membership_result){
                                                ?>
                                                <tr>
                                                    <td scope="row"><?=$i++?></td>
                                                    <td><?=$ready_membership_result->membership_name?></td>
                                                    <td><a class="btn btn-primary" data-popup-open="popup-1" onclick="view_description('<?php echo $ready_membership_result->description; ?>')">View</a></td>
                                                   

                                                    <?php if($ready_membership_result->discount_in == 0): ?>
                                                        <td><?=$ready_membership_result->service_discount?>%</td>
                                                        <!-- <td><?=$ready_membership_result->product_discount?>%</td> -->
                                                        <td>
                                                                <?php 
                                                                    if (!empty($ready_membership_result->product_discount)) {
                                                                        echo $ready_membership_result->product_discount . '%';
                                                                    } else {
                                                                        echo '-'; 
                                                                    }
                                                                ?>
                                                    ...
                                                    <?php else: ?>
                                                        <td>Rs.<?=$ready_membership_result->service_discount?></td>
                                                        <!-- <td>Rs.<?=$ready_membership_result->product_discount?></td> -->
                                                        <td>
                                                            <?php 
                                                                if (!empty($ready_membership_result->product_discount)) {
                                                                    echo 'Rs. ' . $ready_membership_result->product_discount;
                                                                } else {
                                                                    echo '-'; 
                                                                }
                                                            ?>
                                                    ...
                                                    <td><?=$ready_membership_result->membership_price?></td>
                                                    <td><?= ($ready_membership_result->gender == 1) ? 'Female' : (($ready_membership_result->gender == 0) ? 'Male' : 'Unisex'); ?></td>
                                                    <td><?=$ready_membership_result->duration?> Month</td>
                                                    <td style="display: none;"><?=$ready_membership_result->description?></td>
                                                    <td class="status-column-hidden">
                                                        <button type="button" class="btn btn-sm" style="background-color:<?=$ready_membership_result->bg_color;?>; color:<?=$ready_membership_result->text_color;?>"><?=$ready_membership_result->membership_name;?></button>
                                                    </td>
                                                    ...
                                                    <td>
                                                       <?php if(!in_array($ready_membership_result->id,$added_membership)){?>
														<a title="Use This Membership" class="btn btn-primary" href="<?=base_url()?>add-membership?use_this=1&value=<?=$ready_membership_result->id?>">Use This Membership</a>
														<?php }else{?>
														<a title="Added" class="btn btn-info" href="javascript:void(0)">Membership Used</a> 
														<?php }?>  
                                                    </td>
                                                </tr>
                                            <?php }}?>
                ...
                <div class="tab-pane <?php if((isset($_GET['use_this']) && $_GET['use_this'] != "")){?>active<?php }?>" id="3">
					<?php 
						$membership_id = "0";
						$single_setup_offer = array();
						if(!empty($setup_membership)){
							$single_setup_membership = $setup_membership;
							$membership_id = $setup_membership->id;
						}else if(!empty($single_membership)){ 
							$single_setup_membership = $single_membership;
							$membership_id = $single_membership->membership_id;
						} 
					?>
                    <div class="x_panel">
                        <div class="x_content">
                                ...
                                <form method="post" name="offer_form" id="offer_form" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class=" col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="membership_name" id="membership_name" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->membership_name;} ?>" placeholder="Enter membership name">
											<input autocomplete="off" type="hidden" name="id" id="id" value="<?php if (!empty($single_setup_membership) && isset($_GET['edit'])) { echo $single_setup_membership->id; } ?>">
                                            <input autocomplete="off" type="hidden" name="membership_id" id="membership_id" value="<?php echo $membership_id;?>">
                                            <input autocomplete="off" type="hidden" name="membership_gender" id="membership_gender" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->gender; } ?>">
	
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Select Gender<b class="require">*</b></label>
                                            <select class="form-select form-control" name="gender" id="gender" <?php if(isset($_GET['use_this']) || isset($_GET['value'])){ echo 'disabled';} ?>>
                                                <option value="" class="">Select gender</option>
                                                <?php if ($store_category->category == 0){?>
                                                    <option id="male" value="0" <?php if ((!empty($single_setup_membership) && $single_setup_membership->gender == 0)) echo 'selected="selected"'; ?>>Male</option>
                                                    <?php }?>
                                                    <?php if ($store_category->category == 1){?>
                                                    <option id="female" value="1" <?php if ((!empty($single_setup_membership) && $single_setup_membership->gender == 1)) echo 'selected="selected"'; ?>>Female</option>
                                                    <?php }?>
                                                    <?php if ($store_category->category == 2){?>
                                                    <option id="male" value="0" <?php if ((!empty($single_setup_membership) && $single_setup_membership->gender == 0)) echo 'selected="selected"'; ?>>Male</option>
                                                    <option id="female" value="1" <?php if ((!empty($single_setup_membership) && $single_setup_membership->gender == 1)) echo 'selected="selected"'; ?>>Female</option>
                                                    <!-- <option id="female" value="2" <?php if ((!empty($single_setup_membership) && $single_setup_membership->gender == 2)) echo 'selected="selected"'; ?>>Unisex</option> -->
                                                    <?php }?>
                                            </select>
                                        </div>
                                          <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <select name="discount_in" id="discount_in" class="form-control">
                                                    ...
                                                    <option value="0" <?php if ((!empty($single_setup_membership) && $single_setup_membership->discount_in == 0)) echo 'selected="selected"'; ?>>Percentage</option>
                                                    <option value="1" <?php if ((!empty($single_setup_membership) && $single_setup_membership->discount_in == 1)) echo 'selected="selected"'; ?>>Flat</option>
                                                </select>
                                        </div>  
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="service_discount" id="service_discount" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->service_discount;} ?>" placeholder="Enter service discount">
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Product Discount </b></label>
                                            <input autocomplete="off" type="text" class="form-control" name="product_discount" id="product_discount" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->product_discount;} ?>" placeholder="Enter product discount">
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label>Membership Price<b class="require">*</b></label>
                                            <input autocomplete="off" type="text" class="form-control" name="membership_price" id="membership_price" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->membership_price;} ?>" placeholder="Enter membership price">
                                        </div> 
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="duration" id="duration" value="<?php if (!empty($single_setup_membership)) { echo $single_setup_membership->duration;} ?>" placeholder="Enter duration">
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="custom_fields_data">
                                                    ...
                                                    <input autocomplete="off" type="text" class="color_value_input" name="bg_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->bg_color;}else{ echo '#808080';} ?>" id="hexcolor"></input>
                                                    <input autocomplete="off" type="color" id="colorpicker" class="color_input" name="bg_color" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->bg_color;}else{ echo '#808080';} ?>"> 
                                                </div>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="custom_fields_data">
                                                    <label for="department_master">Button Text Color <b class="require">*</b></label>
                                                    <input autocomplete="off" type="text" class="button_text_color_input" name="text_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->text_color;}else{ echo '#000000';} ?>" id="texthexcolor"></input>
                                                    <input autocomplete="off" type="color" id="textcolorpicker" class="text_color_input" name="text_color" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->text_color;}else{ echo '#000000';} ?>"> 
                                                </div>
                                            </div>
                                    </div>
                                    <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <textarea autocomplete="off" type="text" class="form-control" name="description" id="description" placeholder="Enter description"><?php if (!empty($single_setup_membership)) { echo $single_setup_membership->description;} ?></textarea>
                                        </div>
