...
<?php
    ...
    <div class="row dashboard_list_links_row" id="counts_div" style="display:block;">
        <div class="col-md-12 dashboard_menu_list">
            ...
            <div class="dashboard_list_col">
                ...
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('5')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> Mark Attendance </a>
                </div>                
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('0')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> Reminder </a>
                </div>                
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('1')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> Birthday </a>
                </div>
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('2')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> Anniversary </a>
                </div>
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('3')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> Inventory </a>
                </div>
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('4')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> <i class="fas fa-balance-scale"></i> </a>
                </div>
                <div class="btn btn-primary dashboard_list_btn">
                    <a onclick="showDashboardDataPopup('6')" data-toggle="modal" data-target="#DashboardModal" class="add_new_booking"> <i class="fas fa-exclamation-triangle" style="color:#ff0000 !important;"></i> </a>
                </div>
                <!-- <div class="toggle-switch">
                    <input type="checkbox" id="toggleSwitch" class="toggle-switch-checkbox">
                    <label for="toggleSwitch" class="toggle-switch-label"></label>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="2">
                <div class="row tile_count">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-clock-o"></i> Total Service Sale </span>
                            <div class="center-part">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-clock-o"></i> Total Product Sale </span>
                            <div class="center-part">
            ...
            <div class="tab-pane" id="3">
                <div class="row tile_count">
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-user"></i> Memberships Reedemed</span>
                            <div class="center-part">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-user"></i> Packages Reedemed</span>
                            <div class="center-part">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-user"></i> Giftcards Reedemed</span>
                            <div class="center-part">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-user"></i> Coupons Reedemed</span>
                            <div class="center-part">
                    ...
                    <div class="animated flipInY colmd2 col-sm-6 col-xs-12 tile_stats_count">
                        <div class="right">
                            <span class="count_top"><i class="fa fa-user"></i> Offers Reedemed</span>
                            <div class="center-part">
    ...
    <div class="row">
        <!-- <div class="form-group col-lg-4">
            <select class="form-select form-control chosen-select" onchange="setStylistCalendar(this.value)" name="service_stylist_id" id="service_stylist_id">
...
<div class="modal fade" id="ServiceCompleteModal" tabindex="-1" aria-labelledby="exampleModalComplete" aria-hidden="true" >
    <div class="modal-dialog" style="margin-top:175px;width:850px; height:100%;">
        <div class="modal-content" style="height: 300px;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalComplete">Complete Service</h5>
...
<div class="modal fade" id="ServiceCancelModal" tabindex="-1" aria-labelledby="exampleModalCancel" aria-hidden="true" >
    <div class="modal-dialog" style="margin-top:175px;width:500px; height:100%;">
    ...
    function calculateSalesDashbaordCounts(){
        $.ajax({
            ...
            success: function(data) {
                var opts = $.parseJSON(data);
                console.log(opts)
                $('#today_sale_count').text(parseInt(opts.today_service_sale + opts.today_service_product_sale + opts.today_product_sale + opts.today_membership_sale + opts.today_package_sale));
                $('#total_sale_count').text(parseInt(opts.total_service_sale + opts.total_service_product_sale + opts.total_product_sale + opts.total_membership_sale + opts.total_package_sale));
                $('#total_service_sale_count').text(parseInt(opts.total_service_sale));
                $('#total_product_sale_count').text(parseInt(opts.total_service_product_sale + opts.total_product_sale));
                $('#total_package_sale_count').text(parseInt(opts.total_package_sale));
            },
        });
    }
    ...
    function calculateFinanceDashbaordCounts(){
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#total_cash_sales').text(parseInt(response.total_cash_sales));
                $('#total_online_sales').text(parseInt(response.total_online_sales));
                $('#total_card_sales').text(parseInt(response.total_card_sales));
                $('#total_due_sales').text(parseInt(response.total_due_sales));
                $('#total_petty_cash').text(parseInt(response.total_petty_cash));
            },
            error: function() {
                $('.loader_div').hide();
...
function cancelService(id,stylist) {
    ...
    // if(remark != ''){
        ...
        if (confirmed) {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { booking_service_details_id: id, remark: remark },
                success: function(response) {
                    setTimeout(function() {
                        $('.loader_div').hide(); 
                        if(response === '1'){  
    ...
    // }else{
    //     $('#remark_error_' + id).text('Please enter remark!');
    // }
}
function completeService(id,stylist) {
    // if (confirm("Are you sure you want to proceed?")) {
    openConfirmationDialog("Are you sure you want to proceed?", function (confirmed) {
    if (confirmed) {
        $('.loader_div').show();   
...
var ws = new WebSocket("wss:/staginglink.org:8000");
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(arg) {
            ...
            if (arg.event.extendedProps.booking_service_status == "2") {
                ...
                showServiceDetailsDiv(arg.event.extendedProps.booking_service_details_id);
            }
        },
        ...
        events: stylistData.bookings.map(function(booking) {
           ...
           return {
                ...
                booking_service_details_payment_status: booking.payment_status,
                ...
                is_any_service_completed: booking.is_any_service_completed,
                is_any_service_cancelled: booking.is_any_service_cancelled,
                
                booking_service_price: booking.service_price,
                booking_service_discount: booking.received_discount_amount_while_booking,
                booking_service_discounted_price: booking.service_discounted_price_while_booking,

                title: booking.service_name,
                service_name: booking.service_name,
                stylist_name: booking.stylist_name,
                stylist_id: booking.stylist_id,
                service_marathi_name: booking.service_name_marathi,
        ...
        eventContent: function(arg) {
            ...
            if (viewType !== 'dayGridMonth') {
                customerHtml = '<p class="time" style="color:#000;"><b>' + arg.event.extendedProps.customer_name + ', ' + arg.event.extendedProps.customer_mobile + '</b></p>';
                timeHtml = '<p class="time" style="color:#000;">' + arg.timeText + '</p>';
                // timeHtml = '<p class="time" style="color:#000;">' + arg.event.extendedProps.stylist_name + ': ' + arg.timeText + '</p>';
            }
            ...
            if (viewType === 'timeGridWeek' || viewType === 'timeGridDay') {
                if (arg.event.extendedProps.booking_service_status === '0') {
                    if (arg.event.extendedProps.booking_service_details_payment_status === '0') {
                        var eventStartTime = new Date(arg.event.start);
                        var currentTime = new Date();
                        if (eventStartTime > currentTime) {
                            buttonHtml += '<button style="margin-top:10px;background-color:#2d2dcb !important;" title="Add New Service" id="addServiceButton_' + arg.event.extendedProps.booking_service_details_id + '" onclick="showAddServicePopupCalender(event, ' + arg.event.extendedProps.booking_service_details_id + ')" data-toggle="modal" data-target="#addServiceModal" class="btn btn-primary event-action-button"><i class="fas fa-plus-circle"></i></button>';
                        }
                    }
                }
                
                if (arg.event.extendedProps.booking_service_status === '0' || arg.event.extendedProps.booking_service_status === '1') {
                    if (arg.event.extendedProps.booking_service_details_payment_status === '0') {
                        buttonHtml += '<button style="margin-top:10px;background-color:#2d2dcb !important;" title="Generate Bill" type="button" id="bill_generate_button_' + arg.event.extendedProps.booking_service_details_id + '" onclick="showBillGenerationPopupCalendar(event, ' + arg.event.extendedProps.booking_id + ')" data-toggle="modal" data-target="#BookingBillModal" class="btn btn-primary event-action-button"><i class="fas fa-file-invoice"></i></button>';
                    } else {
                        buttonHtml += '<button style="margin-top:10px;background-color:#2d2dcb !important;" title="Receipt" id="receiptButton_' + arg.event.extendedProps.booking_service_details_id + '" onclick="openReceiptLink(event, \'' + btoa(arg.event.extendedProps.booking_id) + '\', \'' + btoa(arg.event.extendedProps.booking_service_payment_id) + '\')" class="btn btn-primary event-action-button"><i class="fas fa-receipt"></i></button>';
                    }
                }
            }

            var editButtonHtml = '';
            if (arg.event.extendedProps.booking_service_status === '0' && arg.event.extendedProps.is_any_service_completed == '0') {
                if (arg.event.extendedProps.booking_service_details_payment_status === '0') {
                    var eventStartTime = new Date(arg.event.start);
                    var currentTime = new Date();
                    if (eventStartTime > currentTime) {
                        if(arg.event.extendedProps.is_any_service_cancelled == '0'){
                            var editButtonHtml = '<button style="margin-top:10px;background-color:#2d2dcb !important;" title="Edit Booking" type="button" id="edit_button_' + arg.event.extendedProps.booking_service_details_id + '" onclick="showBookingEditPopupFromEvent(event, ' + arg.event.extendedProps.booking_id + ')" data-toggle="modal" data-target="#BookingEditModal" class="btn btn-primary event-action-button"><i class="fas fa-pencil"></i></button>';
                        }
                    }
                }
            }

            var eventContentHtml = '<div class="event-container calender_event_' + arg.event.extendedProps.booking_service_details_id + '">' + dotHtml + '<div class="event-info">' + customerHtml + '' + timeHtml + '<p class="title" style="color:#000;"><b>' + arg.event.title + ' | ' + arg.event.extendedProps.service_marathi_name + '</b></p>' + buttonHtml + '' + editButtonHtml + '</div></div>';
            
            if (viewType === 'dayGridMonth') {
                eventContentHtml = '<div class="event-container calender_event_' + arg.event.extendedProps.booking_service_details_id + '">' + dotHtml + '<div class="event-info">' + customerHtml + '' + timeHtml + '<p class="title" style="color:#000;"><b>' + arg.event.title + '</b></p>' + buttonHtml + '' + editButtonHtml + '</div></div>';
            }

            var popuphtml = '' +
                            '<p>' +  arg.event.extendedProps.customer_name + ', ' +  arg.event.extendedProps.customer_mobile + '</p>' +
                            '<p>Service Price: Rs. ' +  parseFloat(arg.event.extendedProps.booking_service_price).toFixed(2) + '</p>' +
                            '<p>Discount: Rs. ' +  parseFloat(arg.event.extendedProps.booking_service_discount).toFixed(2) + '</p>' +
                            '<p>Final Price: Rs. ' +  parseFloat(arg.event.extendedProps.booking_service_discounted_price).toFixed(2) + '</p>';
            setTimeout(() => {
                tippy('.calender_event_' + arg.event.extendedProps.booking_service_details_id + '', {
                    content: popuphtml,
                    allowHTML: true,
                    placement: 'top',
                    theme: 'light-border',
...
function setGrandTotal(bookingID){
    ...
    $('#paid_amount_' + bookingID).val(parseFloat(total).toFixed(2)).attr('max', parseFloat(allowed_max).toFixed(2));
...
function calculatePendingAmount(bookingID){
    grand_total = parseFloat($('#grand_total_hidden_' + bookingID).val());
    paid_amount = parseFloat($('#paid_amount_' + bookingID).val());
    customer_pending_amount = parseFloat($('#customer_pending_amount_' + bookingID).val());
                    ...
                    if (booking_services.length > 0) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if(is_valid == '1'){
                                    if (checkArraysMatch(booking_services.map(service => service.service_d), giftcard_services)) {
                                        if(is_customer_used == '0'){
                                            if (!$.isEmptyObject(custom_array)) {
                                                ...
                                                $.each(custom_array, function(i, d) {
                                                    ...
                                                    if (booking_services.some(bookingService => bookingService.service_d === service)) {
                                                        var details_id = booking_services.find(bookingService => bookingService.service_d === service).details_id;
                                                        service_price = parseFloat($('#single_service_price_'+ details_id).val());
