                                ...
                                <div class="x_content">
                                    <div class="container">
                                        <form method="post" name="customer_form" id="customer_form" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label>Addmission Date <b class="require">*</b></label>
                                                    <input autocomplete="off" type="text" class="form-control datepick " name="add_date" id="add_date" value="<?php if (!empty($single)) { echo $single->add_date; } ?>" placeholder="DD/MM/YYYY">
                                                </div>
...
<script type="text/javascript">
  ...
  <script>
      $(document).ready(function () {
			$('#courses .child_menu').show();
			$('#courses').addClass('nv active');
