                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-info" target="_blank" href="<?= base_url(); ?>admin_assets/images/product_image/<?= $product_master_list_result->product_photo ?>">View</a>
                                                            </td>
                                                            <td><a class="btn btn-info" data-popup-open="popup-1" onclick="view_description('<?php echo  $product_master_list_result->description; ?>')">View</a></td>
                                                            <td>
