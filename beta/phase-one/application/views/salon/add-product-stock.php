                ...
                <div class="container">
                    <form method="post" name="employee_form" id="employee_form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-12" style="display:none;" id="mfg_date_div">
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-12" style="display:none;" id="exp_date_div">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                <label>Product Purchase Price <small>(Per Unit)</small><b class="require">*</b></label>
