    ...
    function get_stylist_revenue(emp_id) {
        ...
        for (var a = 0; a < booking_length; a++) {
            ...
            if(booking_data[a].stylist == emp_id){
                ...
                $('#stylist_revenue_box_'+emp_id+'').html(' <div class="col-md-12">'+ emp_id +'</div>\
                                                     <div class="col-md-4">Today booking <br><span>'+ booking_count +'</span></div>\
                                                    <div class="col-md-4">Todaty Revenue <br><span>'+ total_revenue +'</span></div>\
                                                    <div class="col-md-4"> Available Time Left <br><span> ' + result.hours + ' hrs ' + result.minutes + 'mns</span></div>');
            }
        }
