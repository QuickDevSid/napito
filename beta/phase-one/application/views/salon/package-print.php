                ...
                <table>
                  <thead>
                    <tr class="tm_accent_bg">
                      ...
                      <th class="tm_width_4 tm_semi_bold tm_white_color" style="width:25%;">Package</th>
                      <th class="tm_width_2 tm_semi_bold tm_white_color" style="width:40%;">Services</th>
                      <th class="tm_width_2 tm_semi_bold tm_white_color" style="width:15%;">Period</th>
                  ...
                  <tbody>
                    <tr>
						<td class="tm_width_4" style="width:15%;">Package Payment</td>
						<td class="tm_width_2" style="width:25%;"><?=$customer_amount->package_name?></td>
						<td class="tm_width_2" style="width:40%;"><?=rtrim($services_str, ', ')?></td>
						<td class="tm_width_2" style="width:15%;"><?= ($customer_amount->package_start_date != "" && $customer_amount->package_end_date != "") ? date('d M Y',strtotime($customer_amount->package_start_date)).' to<br>'.date('d M Y',strtotime($customer_amount->package_end_date)) : '-';?></td>
						<td class="tm_width_2 tm_text_right" style="width:5%;"><?=number_format((float)$customer_amount->package_amount, 2, '.', '')?></td>
                    </tr> 
                  </tbody>
                </table>
              </div> 
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=number_format((float)$customer_amount->package_amount, 2, '.', '')?></td>
                    </tr>
                    <?php if($customer_amount->is_gst_applicable == '1'){ ?>
                             <tr class="tm_gray_bg">
                        ...
                        <?php } ?>
                            <tr class="tm_accent_bg">
                                ...
                                <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"><?php echo number_format((float)($customer_amount->package_amount + $customer_amount->gst_amount), 2, '.', ''); ?></td>
                            </tr>
