                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="container">
                                ...
                                <div class="form-group col-md-12 col-sm-6 col-xs-12 customer-btn"  style="display: none;">
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                            <div class="dropdown form-control-model col-md-12 col-sm-6 col-xs-12">
                        ...
                        <div class="x_content">
                            <div class="container">
                                ...
                                <div class="row product_detail_box" style="display: none;">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                       <div name="product_detail" id="product_detail"  class="form-group col-md-12 col-sm-6 col-xs-12"></div>
                                       <div name="total_product_amount" id="total_product_amount"  class="form-group col-md-12 col-sm-6 col-xs-12"></div>
                                    </div>
                                </div>


                                <div class="row pacakge_detail_box" style="display: none;">
                                    <div class="x_title col-md-12 col-sm-6 col-xs-12">
    ...
    if(checkBox.checked == false){
		$('#add_service_' + product_id).remove();
            ...
            $('.add-service-box').append('<div id="add_service_'+ product_id +'"><div class="row service_detail_box">\
                                            ...
                                            <div name="services_name" id="services_name"  class="form-group col-md-12 col-sm-6 col-xs-12">'+ english + '|' + marathi +'</div>\
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">\
