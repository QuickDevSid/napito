            ...
            <div class="">
              <div class="tm_table_responsive">
                <table>
                  ...
                  <tbody>
                    <tr>
						<td class="tm_width_4" style="width:25%;">Membership Payment</td>
						<td class="tm_width_2" style="width:30%;"><?=$customer_amount->membership_name?></td>
						<td class="tm_width_2" style="width:20%;"><?= ($customer_amount->membership_start != "" && $customer_amount->membership_end != "") ? date('d M Y',strtotime($customer_amount->membership_start)).' to '.date('d M Y',strtotime($customer_amount->membership_end)) : '-';?></td>
						<td class="tm_width_2 tm_text_right" style="width:25%;"><?=$customer_amount->membership_price?></td>
                    </tr> 
                  </tbody>
                </table>
              </div> 
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=$customer_amount->membership_price?></td>
                    </tr>
                    <?php if($customer_amount->is_gst_applicable == '1'){ ?>
                             <tr class="tm_gray_bg">
                                <td class="tm_width_3 tm_primary_color">GST <span class="tm_ternary_color">(<?=$customer_amount->salon_gst_rate.'%'; ?>)</span></td>
                                <td class="tm_width_3 tm_primary_color tm_text_right"><?php echo $customer_amount->gst_amount; ?></td>
                            </tr>
                    <?php } ?>
                            <tr class="tm_accent_bg">
                                <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Grand Total </td>
                                <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"><?php echo $customer_amount->membership_price + $customer_amount->gst_amount; ?></td>
                            </tr>
