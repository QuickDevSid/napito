        ...
        <div class="row">
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    ...
                    <li class="active">
                        <a class="" href="<?=base_url()?>employee_incentive_master" >Empolyee Target Setup</a>
                    </li>
                                        ...
                                        <div class="row">   
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <select class="form-select form-control" name="per_or_flat" id="per_or_flat">
                                                    ...
                                                    <option <?=(!empty($single) && $single->per_or_flat == '1') ? 'selected' : ''; ?> value="1" class="">Percentage</option>
                                                    <option <?=(!empty($single) && $single->per_or_flat == '2') ? 'selected' : ''; ?> value="2" class="">Flat</option>
                                                </select>
                                            ...
                                            <table id="example" class="table table-striped responsive-utilities jambo_table" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($list->per_or_flat == '1'){
                                                                echo $list->incentive.'%';
                                                            }elseif($list->per_or_flat == '2'){ 
