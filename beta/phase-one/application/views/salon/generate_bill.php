                ...
                <div class="x_content">
                    <div class="calender_booking_details" style="background-color: #f7f7ff;">
                        <table style="width:100%;">
                            <thead>
                                <tr style="background-color: #bbe4ff;border-bottom: 0.5px solid #afafaf;border-top: 0.5px solid #afafaf;">
                                    <th>Customer</th>
                                    <th>Booking Date</th>
                                    <th>Booking Amt</th>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="calender_booking_details service_details_div service_details_box" style="background-color: #f7f7ff;height: 500px; overflow-y: scroll; border: 0.5px solid #afafaf;">
                                        <table style="width:100%;">
                                            <thead>
                                                <tr style="background-color: #bbe4ff;border-bottom: 0.5px solid #afafaf;">
                                                                                ...
                                                                                <table style="width:100%; border: 0.5px solid #afafaf;">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php
                                                                                            if(!empty($booking_products)){
                                                                                                foreach($booking_products as $booking_products_result){
                                                                                                    ...
                                                                                                    $discount_in = $booking_products_result->discount_in;
                                                                                                    $discount = $booking_products_result->discount != "" ? (float)$booking_products_result->discount : 0;
                                                                                                    $selling_price = $booking_products_result->selling_price != "" ? (float)$booking_products_result->selling_price : 0.00;
                                                                                                    if($discount_in == '0'){
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="color:black;"><?=($selling_price != "") ? $selling_price : '0.00';?></td>
                                                                                        </tr>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-xs-12" id="message_type_div_<?=$booking->id;?>" style="display:none;">
