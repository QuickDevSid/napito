    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                ...
                <a  class="service-setup" href="<?= base_url(); ?>add-salon-services"><div style="font-size: 20px;"><?php if (isset($category_name)) { echo $category_name; } ?> <span style="font-size: 17px;"> <i class="fa-solid fa-arrow-right"></i> <span></div></a>
            </div>
