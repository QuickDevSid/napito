						...
						<div class="col-lg-6 col-md-6 one pd-0">
							<div class="form-group">
								...
								<div class="col-lg-8 col-md-8 input_error">
									<input type="text" readonly name="attendance_date" id="attendance_date" placeholder="DD-MM-YYYY" class="form-control" value="<?php if(isset($_GET['date']) && $_GET['date'] != ""){ echo date('d-m-Y',strtotime($_GET['date'])); }else{ echo date('d-m-Y'); } ?>">
								</div>
