                                ...
                                <div class="x_content">
                                    <div class="container">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="sup_category_marathi" id="sup_category_marathi" value="<?php if(!empty($single)){ echo $single->sup_category_marathi; }?>" placeholder="Enter category">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
