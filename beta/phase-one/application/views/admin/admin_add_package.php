                                ...
                                <form method="post" class="form-group" name="customer_form" id="customer_form" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="package_name_marathi" id="package_name_marathi" value="<?php if(!empty($single)){ echo $single->package_name_marathi; }?>" placeholder="Enter package name in मराठी">
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <label style="display:block;">Service <b class="require">*</b></label> 
                                                <?php  
													...
													<option value="<?=$service_name_result->id?>" <?php if(!empty($single) && in_array($service_name_result->id,$service_exp)){?>selected="selected"<?php }?>><?=$service_name_result->service_name?></option>
                                                <?php }
                                                } ?>
												</select>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <input type="hidden" name="old_package_image" id="old_package_image" value="<?php if(!empty($single)){ echo $single->package_image; }?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="Enter description"><?php if (!empty($single)) {echo $single->description; } ?></textarea>
                                        </div> 
                                    </div>
                                    <pre></pre>
                                    <div class="row">
