                        ...
                        <form method="post" name="master_form" id="master_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div style="margin-bottom: 10px !important;" class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12 checkbox-container">
                                        <div id="feature-list">
                                            ...
                                            <input type="checkbox" class="services-checkbox" name="feature[]" id="feature_<?= $service_name->id ?>" <?php if(in_array($service_name->id,$required_features)){ echo 'checked disabled'; }elseif (in_array($service_name->id,$service_exp)){ echo 'checked'; }?> value="<?= $service_name->id ?>">
...
<script>
    $(document).ready(function () {function updateCheckAll() {
