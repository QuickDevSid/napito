                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="make_form" name="make_form" method="get" enctype="multipart/form-data" data-parsley-validate>
						...
						<div class="col-md-3" style="<?php echo ($this->session->userdata('user_type') == "0") ? 'display:block;' : 'display:none;'; ?>">
						...
						<div class="form-group col-lg-3">
							...
							<input id="date" autocomplete="off" class="form-control" placeholder="Select Survey Date" name="date" value="<?php if(isset($_GET['date']) && ($_GET['date'] != '')){ echo date('d-m-Y',strtotime($_GET['date'])); } ?>">
						</div>
