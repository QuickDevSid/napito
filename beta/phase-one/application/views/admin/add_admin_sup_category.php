                                ...
                                <div class="x_content">
                                    <div class="container">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" name="sup_category" id="sup_category" <?php if(isset($_GET['flag']) && base64_decode($_GET['flag']) == 'not_allowed'){ echo 'readonly'; } ?> value="<?php if(!empty($single)){ echo $single->sup_category; }?>" placeholder="Enter category">

                                            <div class="error" id="sup_category_error"></div>
                                            <input autocomplete="off" type="hidden" class="form-control" name="id" id="id" value="<?php if(!empty($single)){ echo $single->id; }?>">
                                            <input autocomplete="off" type="hidden" class="form-control" name="old_category_image" id="old_category_image" value="<?php if(!empty($single)){ echo $single->category_image; }?>">
                                            <input autocomplete="off" type="hidden" class="form-control" name="old_sup_category" id="old_sup_category" value="<?php if(!empty($single)){ echo $single->sup_category; }?>">
                                            <input autocomplete="off" type="hidden" class="form-control" name="old_sup_category_marathi" id="old_sup_category_marathi" value="<?php if(!empty($single)){ echo $single->sup_category_marathi; }?>">
                                            <input autocomplete="off" type="hidden" class="form-control" name="not_allowed" id="not_allowed" value="<?php if(isset($_GET['flag']) && base64_decode($_GET['flag']) == 'not_allowed'){ echo base64_decode($_GET['flag']); } ?>">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <label>Add Category In मराठी<b class="require">*</b></label>
                                            <input autocomplete="off" type="text" class="form-control" <?php if(isset($_GET['flag']) && $_GET['flag'] == base64_encode('not_allowed')){ echo 'readonly'; } ?> name="sup_category_marathi" id="sup_category_marathi" value="<?php if(!empty($single)){ echo $single->sup_category_marathi; }?>" placeholder="Enter category">
                                        </div>
                                        </div>
                                        <div class="row cc_row">
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tbody>
                                        	...
                                        	?>
                                            <tr class="draggable-rows" data-id="<?=$category_name_list_result->id;?>" data-order="<?=$category_name_list_result->order;?>">
