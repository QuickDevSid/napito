...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            ...
            ?>
        <p><h4 style="color:#0052cc;"><?=$status_text;?> Booking Rules Update Requests</h4></p>
        <label style="color:#0052cc;">Salon: <?= !empty($branch) ? $branch->branch_name.', '.$branch->salon_name.' ' : ""; ?></label>
        </div>
