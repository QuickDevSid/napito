        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    ...
                    <div class="profile_img">
                        ...
                        <div id="crop-avatar">
                            ...
                            <div class="avatar-view" title="Change the avatar">
                                <img src="https://cdn3.vectorstock.com/i/1000x1000/30/97/flat-business-man-user-profile-avatar-icon-vector-4333097.jpg" alt="Avatar">
                            </div>
                    ...
                    <?php if(!empty($get_single_lead_info)){
                            $i = 1;
                            foreach($get_single_lead_info as $get_single_lead_info_result){
                        ?>
                    <h3><?=$get_single_lead_info_result->salon_owner_name?></h3>

                   
                    <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> <?=$get_single_lead_info_result->salon_address?>,India
                        </li>

                        <li>
                            <i class="fa-solid fa-phone user-profile-icon"></i><?=$get_single_lead_info_result->salon_number?>
                        </li>
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul style="background: white" id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
