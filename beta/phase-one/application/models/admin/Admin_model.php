...
class Admin_model extends CI_Model { 
    ...
    public function set_branch($shopact){
        ...
        if($this->input->post('id') == ""){
            ...
            if(!empty($subscription)){
                ...
                if($subscription->subscription_name == 'Basic'){
                    $design_array = ['Stylist'];
                }elseif($subscription->subscription_name == 'Premium'){
                    $design_array = ['Stylist','Receptionist','Owner','Manager'];
                }elseif($subscription->subscription_name == 'Standard'){
            ...
            if(!empty($exist_branch)){
                ...
                if($new_subscription != $old_subscription){
                    ...
                    // $socket_response = $this->Salon_model->send_data_to_socket_client($uid,$type,$project,$message,$data);
                }
    ...
    public function get_subcategory_products($id){
        $this->db->where('tbl_product.is_deleted', '0');
        $this->db->where('tbl_product.product_subcategory', $id);
        $query = $this->db->get('tbl_product');
        return $query->result();
    }
    ...
    public function get_branch_coin_history($branch){
        if($branch != ""){
            ...
            $this->db->order_by('tbl_salon_coin_history.created_on','desc');
    ...
    public function get_all_sub_category_list() {
        ...
        $this->db->order_by('tbl_admin_sub_category.id', 'DESC');
...
public function get_single_status_color()
	...
	public function get_all_product_sub_category(){ 
        ...
        $this->db->order_by('tbl_product_sub_category.id','DESC');
        $result = $this->db->get('tbl_product_sub_category');
        return $result->result();
    }
