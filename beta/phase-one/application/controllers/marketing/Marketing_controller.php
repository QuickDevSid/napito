...
class Marketing_controller extends CI_Controller {
	public function survey_form() {
		if ($this->input->post('submit_basic_info') == 'submit_basic_info') {
			$last_id = $this->Marketing_model->submit_survey_form();
			if ($last_id) {
		...
		if ($this->input->post('submit_other_info') == 'submit_other_info') {
			...
			if ($last_id) {
				...
				$this->Marketing_model->submit_form($last_id,$salon_owner_selfie);
		...
		$this->load->view('marketing/survey_form',$data);
	}
	...
	public function thank_you(){
		$this->load->view('marketing/thank_you');
	} 
}
