...
$route['add-branch/(:any)/(:any)']="admin/Admin_controller/add_branch/$1";
...
$route['salon_do_logout'] = "salon/Salon_controller/salon_do_logout";
$route['inactive/(:any)/(:any)']='salon/Salon_controller/inactive/$1';
$route['active/(:any)/(:any)']='salon/Salon_controller/active/$1';
$route['delete/(:any)/(:any)']='salon/Salon_controller/delete/$1';
...
$route['membership-print/(:any)']="Welcome/membership_print/$1";
$route['package-print/(:any)']="Welcome/package_print/$1";
$route['giftcard-print/(:any)']="Welcome/giftcard_print/$1";
...
$route['store-profile']='salon/Salon_controller/store_profile';
$route['working-hours']='salon/Salon_controller/working_hours';
$route['working-hours/(:any)']='salon/Salon_controller/working_hours/$1';
$route['working-hours/(:any)/(:any)']='salon/Salon_controller/working_hours/$1';
...
$route['salon-bank-details']='salon/Salon_controller/salon_bank_details';
$route['salon-location']='salon/Salon_controller/salon_location';
...
$route['salon_print_salary_slip/(:num)'] = "Welcome/print_salary_slip/$1";
...
$route['product-list/(:any)'] = "salon/Salon_controller/product_list/$1"; 
$route['add-product'] = "salon/Salon_controller/add_product"; 
$route['use_ready_product_cat/(:any)/(:any)'] = "salon/Salon_controller/use_ready_product_cat/$1"; 
$route['use_ready_product_sub_cat/(:any)'] = "salon/Salon_controller/use_ready_product_sub_cat/$1"; 
...
$route['add_employee'] = "salon/Salon_controller/add_employee"; 
$route['add_employee/(:any)'] = "salon/Salon_controller/add_employee/$1"; 
...
$route['add_employee_list'] = "salon/Salon_controller/add_employee_list"; 
$route['add-gallary'] = "salon/Salon_controller/add_gallary"; 
$route['add-gallary/(:any)'] = "salon/Salon_controller/add_gallary/$1"; 
$route['add-salon-services'] = "salon/Salon_controller/add_salon_services"; 
$route['add-salon-services/(:any)'] = "salon/Salon_controller/add_salon_services/$1"; 
$route['add-salon-services/(:any)/(:any)'] = "salon/Salon_controller/add_salon_services/$1"; 
$route['salon-services-list/(:any)'] = "salon/Salon_controller/add_salon_services_list/$1"; 
...
$route['ready-sub-category/(:any)'] = "salon/Salon_controller/ready_sub_category/$1";  
$route['ready-services/(:any)/(:any)'] = "salon/Salon_controller/ready_services/$1"; 
...
$route['employee_incentive_master'] = "salon/Salon_controller/employee_incentive_master"; 
$route['employee_incentive_master/(:any)'] = "salon/Salon_controller/employee_incentive_master/$1"; 
...
$route['add-package'] = "salon/Salon_controller/add_package"; 
$route['add-package/(:any)'] = "salon/Salon_controller/add_package/$1"; 
$route['package-list'] = "salon/Salon_controller/package_list"; 

$route['add-offers'] = "salon/Salon_controller/add_offers"; 
$route['add-offers/(:any)'] = "salon/Salon_controller/add_offers/$1"; 
$route['offers-list'] = "salon/Salon_controller/offers_list"; 

$route['add-coupon-code'] = "salon/Salon_controller/add_coupon_code"; 
$route['add-coupon-code/(:any)'] = "salon/Salon_controller/add_coupon_code/$1"; 
...
$route['add-salon-facility'] = "salon/Salon_controller/add_facility"; 
$route['add-salon-facility/(:any)'] = "salon/Salon_controller/add_facility/$1"; 

$route['add-course'] = "salon/Salon_controller/add_course"; 
$route['add-course/(:any)'] = "salon/Salon_controller/add_course/$1"; 
$route['course-list'] = "salon/Salon_controller/course_list"; 
$route['add-reward-point'] = "salon/Salon_controller/add_reward_point"; 
$route['add-reward-point/(:any)'] = "salon/Salon_controller/add_reward_point/$1"; 
...
$route['add-gift-card'] = "salon/Salon_controller/add_gift_card";
$route['add-gift-card/(:any)'] = "salon/Salon_controller/add_gift_card/$1";
$route['gift-card-list'] = "salon/Salon_controller/gift_card_list";

$route['add-membership'] = "salon/Salon_controller/add_membership";
$route['add-membership/(:any)'] = "salon/Salon_controller/add_membership/$1";
$route['membership-list'] = "salon/Salon_controller/membership_list";
...
$route['mobile-booking-print/(:any)'] = "Welcome/mobile_booking_print/$1"; 
$route['booking-print/(:any)/(:any)'] = "Welcome/booking_print/$1"; 
$route['product-booking-print/(:any)/(:any)'] = "Welcome/product_booking_print/$1"; 
...
$route['complete-profile'] = "salon/Salon_controller/complete_profile"; 
...
$route['add-message']="salon/Salon_controller/add_message";
$route['send_customize_message']="salon/Salon_controller/send_customize_message";
$route['send_offer_message']="salon/Salon_controller/send_offer_message";

$route['birthday'] = "salon/Salon_controller/birthday"; 
$route['anniversary'] = "salon/Salon_controller/anniversary"; 
$route['service_repeat'] = "salon/Salon_controller/service_repeat"; 
$route['cancel_appointment'] = "salon/Salon_controller/cancel_appointment"; 
$route['lost_customer'] = "salon/Salon_controller/lost_customer"; 
$route['offer'] = "salon/Salon_controller/offer"; 
$route['customize_message'] = "salon/Salon_controller/customize_message"; 
...
$route['client_consent_form']="Welcome/client_consent_form";
$route['consent_thank']="Welcome/consent_thank";
...
$route['update-emergency-closure']="Welcome/update_emergency_closure";
//CRON everyday shift change
$route['change-rotational-shift']="Welcome/change_rotational_shift";

//CRON every day morning 9am
$route['anniversary-wish']="Welcome/send_anniversary_wish";
//CRON every day morning 9am
$route['birthday-wish']="Welcome/send_birthday_wish";
//CRON every day evening 7pm
$route['service-reminder']="Welcome/send_service_reminder";
//CRON every day evening 8pm
$route['lost-customer-message']="Welcome/send_lost_customer_message";
//CRON every day evening 9pm
$route['tomorrow-booking-reminder']="Welcome/send_tomorrow_booking_reminder";
//CRON every day morning 8am
$route['today-booking-reminder']="Welcome/send_today_booking_reminder";
//CRON every day 3 times (8 Hrs Apart)
$route['reset-expired-subscriptions']="Welcome/reset_expired_subscriptions";
...
// Marketing Routes
$route['survey'] = 'marketing/Marketing_controller/survey_form';
$route['survey/(:any)'] = 'marketing/Marketing_controller/survey_form/$1';
$route['survey/(:any)/(:any)'] = 'marketing/Marketing_controller/survey_form/$1';
$route['survey/(:any)/(:any)/(:any)'] = 'marketing/Marketing_controller/survey_form/$1';

$route['thank-you'] = 'marketing/Marketing_controller/thank_you';
