	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				...
				{ text: 'Last 3 Months', dateStart: function() { return moment().subtract(3, 'months').startOf('month') }, dateEnd: function() { return moment() } },
        		{ text: 'Last 6 Months', dateStart: function() { return moment().subtract(6, 'months').startOf('month') }, dateEnd: function() { return moment() } }
			],
