	...
	public function is_allowed(){
		if(!in_array($this->uri->segment(1),explode(',',$this->session->userdata('subscription_feature_slugs')))){
			...
			if($onboarding_status < '18'){
				$this->session->set_flashdata('message', 'You are not allowed to access this feature. You can skip this step.');
			}else{
	...
	public function store_profile(){
		...
		if($onboarding_status >= '0'){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($result == 0){
					$this->session->set_flashdata('success','Store profile set successfully');
				}else{
					$this->session->set_flashdata('success','Store profile updated successfully');
				}
	...
	public function working_hours(){
		...
		if($onboarding_status >= '1'){
			...
			if ($this->input->post('work-shedule-btn') == 'work-shedule-btn') {
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Working Hours set successfully');
					redirect('working-hours/3');
				} else {
					$this->session->set_flashdata('success', 'Working Hours updated successfully');
					redirect('working-hours/3');
				}
			}
			...
			elseif($this->input->post('salon-time-btn') == 'salon-time-btn') {
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Salon Time set successfully');
				} else {
					$this->session->set_flashdata('success', 'Salon Time updated successfully');
				}
	...
	public function salon_location(){
		...
		if($onboarding_status >= '3'){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($result == "0"){
					$this->session->set_flashdata('success','Salon Location added successfully');
				}else{
					$this->session->set_flashdata('success','Salon Location updated successfully');
				}
	...
	public function add_facility(){
		...
		if($onboarding_status >= '4'){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($result == "0"){
					$this->session->set_flashdata('success','Salon Facility added successfully');
				}else{
					$this->session->set_flashdata('success','Salon Facility updated successfully');
				}
			...
			if($this->session->userdata('store_gender') != ""){
				...
				if ($this->form_validation->run() === FALSE) {
					...
					if($this->input->post('is_ready_service') == '1'){
						...
						if($onboarding_status < '18'){
							// redirect('add-membership');
							if($this->input->post('is_add_new') == '1'){
								redirect('add-salon-services?pending');
							}else{
								redirect('salon-services-list/'.$this->input->post('old_category'));
							}
						}else{
							if($this->input->post('is_add_new') == '1'){
								redirect('add-salon-services?pending');
	...
	public function add_reward_point(){
		...
		if($onboarding_status >= '13'){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($result == "0"){
					$this->session->set_flashdata('success','Reward points added successfully');
				}else{
					$this->session->set_flashdata('success','Reward points updated successfully');
				}
				if($onboarding_status < '18'){
	...
	public function employee_incentive_master(){
		...
		if($onboarding_status >= '15'){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($result == '0'){
					$this->session->set_flashdata('success','Employee Incentive added successfully');
				}else{
					$this->session->set_flashdata('success','Employee Incentive updated successfully');
				}
				if($onboarding_status < '18'){
	...
	public function add_automated_marketing() {
		...
		if($onboarding_status >= '14'){
			if ($this->input->post('new_client_submit') == 'new_client_submit') {	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'New Client marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'New Client marketing discount set successfully');
				}				
				if($onboarding_status < '18'){
					// redirect('employee_incentive_master');	
					redirect('add_automated_marketing?type=all');	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Regular Client marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'Regular Client marketing discount set successfully');
				}							
				if($onboarding_status < '18'){
					// redirect('employee_incentive_master');
					redirect('add_automated_marketing?type=all');	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Lost Client marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'Lost Client marketing discount set successfully');
				}							
				if($onboarding_status < '18'){
					// redirect('employee_incentive_master');
					redirect('add_automated_marketing?type=all');	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Birthday marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'Birthday marketing discount set successfully');
				}							
				if($onboarding_status < '18'){
					// redirect('employee_incentive_master');
					redirect('add_automated_marketing?type=all');	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Anniversary marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'Anniversary marketing discount set successfully');
				}							
				if($onboarding_status < '18'){
					// redirect('employee_incentive_master');
					redirect('add_automated_marketing?type=all');	
				...
				if ($result == "0") {
					$this->session->set_flashdata('success', 'Products marketing discount updated successfully');
				} else {
					$this->session->set_flashdata('success', 'Products marketing discount set successfully');
				}							
				if($onboarding_status < '18'){
					redirect('add_automated_marketing?type=all');	
					// redirect('add_automated_marketing?type=product_marketing');	
