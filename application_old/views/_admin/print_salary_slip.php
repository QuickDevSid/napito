		...
		<table style="border: 1px solid #000;margin: 30px auto 0px; width:55%" class="parent_table">
			<tr style="border: 1px solid #000;text-align: center;">
				<td colspan="4" style="padding: 10px 15px;">
					<h4 style="font-size: 30px;font-weight: 600;">Saurabh Travels</h4>
					<p style="margin: 0px auto;width: 450px;font-size: 14px;">Burudgaon Rd, Opp. Nakshatra Lawn, Ahinsanagar, Ahmednagar, Maharashtra 414110</p>
				</td>
			</tr>
			<tr style="border: 1px solid #000;text-align: center;">
				<?php $month_name = '';
				...
				<td colspan="4" style="padding: 6px;">
					<p style="font-size: 16px;font-weight: 600;margin-bottom: 0px;">Pay Slip for the month of <?=$month_name;?> - <?php if(!empty($slip)){ echo $slip->salaried_year;}?> (Payment Date: <?php if(!empty($slip)){ echo date("d/m/Y",strtotime($slip->payed_date));}?>)</p>
				</td>
			</tr>
			<tr style="border: 1px solid #000;text-align: center;">
				<td colspan="4" style="padding: 6px;">
