    ...
    <div class="">
        ...
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <div class="container">
                        <form style="display: flex;flex-wrap:wrap;" method="post" name="employee_form" id="employee_form" enctype="multipart/form-data">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <h3 style="color: #323232; font-weight: bold;">Personal Details</h3>
                                </div>
                            </div>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  style="margin-bottom: 10px" >
                                <div class="form-group">
                                    <h3 style="color: #323232; font-weight: bold;">Eduction Details</h3>
                                </div>
                            </div>
