                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                   <table id="example" class="table table-striped responsive-utilities jambo_table">
                                            ...
                                            <tbody>
                                                <?php if(!empty($website_contact)){
                                                    $i=1;
                                                        foreach($website_contact as $website_contact_result){ ?>
                                                <tr>
                                                    <td scope="row"><?=$i++?></td>
                                                    <td><?=$website_contact_result->name?></td>
                                                    <td><?=$website_contact_result->email?></td>
                                                    <td><?=$website_contact_result->message?></td>
                                                    <td><a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?');" href="<?=base_url()?>admin_delete/<?=$website_contact_result->id?>/tbl_contact_us"><i class="fa-solid fa-trash"></i></a></td>
                                                </tr>
                                            <?php }}?>
                                            </tbody>
                                        </table>
