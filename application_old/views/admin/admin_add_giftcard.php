                                ...
                                <form method="post" name="gift_form" id="gift_form" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <select class="form-select form-control gift_card_code" name="gender" id="gender">
                                      ...
                                      <!-- <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                       ...
                                       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                            ...
                                            <div id="price_div">
                                                <input autocomplete="off" type="text" class="form-control gift_card_code" name="gift_card_code" id="gift_card_code" value="<?php if (!empty($single)) {echo $single->gift_card_code;} ?>" placeholder="Enter gift card code">
...
$(".gift_card_code").on("keyup change", function () {
    ...
    if($("#gender").val() !=""){
        $.ajax({
            ...
            data:{'gift_card_code':$("#gift_card_code").val(),'gender':$("#gender").val(),'id':'<?=$id?>'},
