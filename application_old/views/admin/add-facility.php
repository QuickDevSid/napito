  ...
  <!-- page content -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <div class="container">
                            <form method="post" class="row" name="master_form" id="master_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input style="height: 42px;" type="file" accept=".png,.jpg.jpeg" class="form-control" name="icon" id="icon">
                                    ...
                                    <table class="table table-striped" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?');" href="<?=base_url()?>admin_delete/<?=$facility_list_result->id?>/tbl_facility_master?facilities"><i class="fa-solid fa-trash"></i></a>	

                                                	<a title="Edit" class="btn btn-success" href="<?=base_url()?>add-facility/<?=$facility_list_result->id?>"><i class="fa-solid fa-pen-to-square"></i></a>	
                                                </td>
                                            </tr>
                                        <?php }}?>
                                        </tbody>
...
<script>
        ...
        $("#facility_name").keyup(function(){  
            $.ajax({
                type: "POST",
                url: "<?=base_url();?>admin/Ajax_controller/get_unique_facility_name",
