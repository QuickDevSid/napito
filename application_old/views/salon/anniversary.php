    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Anniversary <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Next Anniversary<br><small>(In Days)</small></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_anniversary_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            const name = "{{Customer}}";
            const discount_text = "{{Discount Text}}";
            const signature = "{{Salon Name}}";

            const message = `
                <p>Hi ${name},</p>
                <p>Your anniversary is a milestone worth celebrating! 🎉💖</p>
                <p>As a special gift, enjoy a ${discount_text} valid during your anniversary week.</p>
                <p>Make this occasion extra special—book your appointment today!</p>
                <p>With love,<br>${signature}</p>
            `;
...
<script>
    $(document).ready(function() {
        ...
        $('.anniversary-setup').addClass('active_cc');
    });
</script>
