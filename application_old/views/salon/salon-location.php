...
let marker;
let autocomplete;
var office_longitude = <?php if(!empty($single_logo)){ echo $single_logo->longitude != "" ? (float)$single_logo->longitude : 78.96288;}else{ echo 78.96288; }?>;
var office_latitude = <?php if(!empty($single_logo)){ echo $single_logo->latitude != "" ? (float)$single_logo->latitude : 20.593684;}else{ echo 20.593684; }?>;
