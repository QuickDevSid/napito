                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($shift_list_result->customer_consent_status == "0"){ ?>
                                                    <button title="Share Again" style="height:unset;padding: 4px 8px !important;" type="button" onclick="showPopup('exampleModal','<?=$shift_list_result->id;?>')" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">
                                                        <i style="font-size: 17px;" class="fas fa-share-alt"></i>
                                                    </button>
                                                <?php } ?>
                                            </td>
                                        </tr>
