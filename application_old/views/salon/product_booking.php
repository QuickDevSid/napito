                            ...
                            <div class="container">
                                ...
                                <div class="row confirm_btn_box">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                        <button type="submit" class="btn btn-info" style="width: 100%;" id="booking_button" name="booking_button" value="booking_button">Confirm Purchase</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#product_booking_management').addClass('nv active');
        $("#dob").datepicker({
            dateFormat: 'dd-mm-yy',
        ...
        $('#booking_form').validate({
            ...
            submitHandler: function(form) {
                if (confirm("Are you sure you want to confirm purchase?")) {
                    form.submit();
                }
            }
        });
