                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="new_client_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="new_client">New Client <small>(First Booking)</small></h3>
                                    <div> 
                                        <?php if (!empty($single_new)) { ?> 
                                            <?php if ($single_new->discount_status == '0') { ?> 
                                                <a onclick="return confirm('Are you sure you want to activate the marketing discount?');" href="<?= base_url(); ?>activate_marketing_discount/0" title="Active Marketing Discount">
                                                    <i id="discount_status_on_0" class="fa-solid fa-toggle-off" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } else { ?> 
                                                <a onclick="return confirm('Are you sure you want to inactivate the marketing discount?');" href="<?= base_url(); ?>inactivate_marketing_discount/0" title="Inactive Marketing Discount">
                                                    <i id="discount_status_off_0" style="color: green;" class="fa-solid fa-toggle-on" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } ?> 
                                        <?php } ?> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_0" id="discount_in_0" class="form-control chosen-select">
                                            ...
                                            <option value="0" <?php if (!empty($single_new) && $single_new->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_new) && $single_new->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <input autocomplete="off" value="<?php if (!empty($single_new)) { echo $single_new->discount_amount; } else { echo 20; } ?>" type="text" name="discount_amount_0" id="discount_amount_0" class="form-control" placeholder="Discount Amount"> 
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                        <input type="radio" name="service_option_0" id="all_service_0" value="0" <?php if (!empty($single_new) && $single_new->for_service == '0') { echo 'checked'; } ?> onclick="toggleServiceDropdown_0()">
                                        <span>All service</span> 
                                        <input type="radio" name="service_option_0" id="selected_service_0" value="1" <?php if (!empty($single_new) && $single_new->for_service == '1') { echo 'checked'; } ?> onclick="toggleServiceDropdown_0()">
                                        <span>Selected service</span> 
                                        <span for="service_option_0" style="display:block;" generated="true" class="error invalid-feedback"></span> 
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_0" style="<?php 
                                                                                                                            if (!empty($single_new)) {
                                                                                                                                if ($single_new->for_service == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="regular_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="regular_client" name="regular_client">Regular Client <small>(Reward Points)</small></h3> 
                                    <div> 
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_1" id="discount_in_1" class="form-control chosen-select">
                                            <option value="">Select Discount In</option>
                                            <option value="0" <?php if (!empty($single_regular) && $single_regular->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_regular) && $single_regular->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_type_1" id="discount_type_1" class="form-control chosen-select">
                                            ...
                                            <option value="1" <?php if (!empty($single_regular) && $single_regular->discount_type == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flexible</option>
                                            <option value="0" <?php if (!empty($single_regular) && $single_regular->discount_type == '0') {
                                                                    echo 'selected';
                                                                } ?>>Fixed</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12 regular_discount_amount" style="<?php 
                                                                                                                            if (!empty($single_regular)) {
                                                                                                                                if ($single_regular->discount_type == '0') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                                                                                                                        ...
                                                                                                                        ?>"> 
                                        <label>Discount Amount<b class="require">*</b></label> 
                                        <input autocomplete="off" value="<?php if (!empty($single_regular) && $single_regular->discount_type == '0') { echo $single_regular->discount_amount; } else { echo '20'; } ?>" type="text" name="discount_amount_1" id="discount_amount_1" class="form-control" placeholder="Discount Amount"> 
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group flexible_discount col-md-4 col-sm-4 col-xs-12 flexible_min" style="<?php 
                                                                                                                                    if (!empty($single_regular)) {
                                                                                                                                        if ($single_regular->discount_type == '1') {
                                                                                                                                            echo 'display: block;';
                                                                                                                                        } else {
                                                                                                                                            echo 'display: none;';
                                                                                                                                        }
                                    ...
                                    <div class="form-group flexible_discount col-md-4 col-sm-4 col-xs-12 flexible_max" style="<?php 
                                                                                                                                    if (!empty($single_regular)) {
                                                                                                                                        if ($single_regular->discount_type == '1') {
                                                                                                                                            echo 'display: block;';
                                                                                                                                        } else {
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_1" style="<?php 
                                                                                                                            if (!empty($single_regular)) {
                                                                                                                                if ($single_regular->for_service == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="lost_client_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="new_client">Lost Client</h3> 
                                    <div> 
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_2" id="discount_in_2" class="form-control chosen-select">
                                            <option value="">Select Discount In</option>
                                            <option value="0" <?php if (!empty($single_lost) && $single_lost->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_lost) && $single_lost->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        <label>Discount Amount<b class="require">*</b></label> 
                                        <input autocomplete="off" value="<?php if (!empty($single_lost)) { echo $single_lost->discount_amount; } else { echo 20; } ?>" type="text" name="discount_amount_2" id="discount_amount_2" class="form-control" placeholder="Discount Amount"> 
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                        <input type="radio" name="service_option_2" id="all_service_2" value="0" <?php if (!empty($single_lost) && $single_lost->for_service == '0') { echo 'checked'; } ?> onclick="toggleServiceDropdown_2()">
                                        <span>All service</span> 
                                        <input type="radio" name="service_option_2" id="selected_service_2" value="1" <?php if (!empty($single_lost) && $single_lost->for_service == '1') { echo 'checked'; } ?> onclick="toggleServiceDropdown_2()">
                                        <span>Selected service</span> 
                                        <span for="service_option_2" style="display:block;" generated="true" class="error invalid-feedback"></span> 
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_2" style="<?php 
                                                                                                                            if (!empty($single_lost)) {
                                                                                                                                if ($single_lost->for_service == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="birthday_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="new_client">Birthday Offers</h3> 
                                    <div> 
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_3" id="discount_in_3" class="form-control chosen-select">
                                            <option value="">Select Discount In</option>
                                            <option value="0" <?php if (!empty($single_birthday) && $single_birthday->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_birthday) && $single_birthday->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        <label>Discount Amount<b class="require">*</b></label> <input autocomplete="off" value="<?php if (!empty($single_birthday)) { echo $single_birthday->discount_amount; } else { echo 20; } ?>" type="text" name="discount_amount_3" id="discount_amount_3" class="form-control" placeholder="Discount Amount"> 
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                        <input type="radio" name="service_option_3" id="all_service_3" value="0" <?php if (!empty($single_birthday) && $single_birthday->for_service == '0') { echo 'checked'; } ?> onclick="toggleServiceDropdown_3()">
                                        <span>All service</span> 
                                        <input type="radio" name="service_option_3" id="selected_service_3" value="1" <?php if (!empty($single_birthday) && $single_birthday->for_service == '1') { echo 'checked'; } ?> onclick="toggleServiceDropdown_3()">
                                        <span>Selected service</span> 
                                        <span for="service_option_3" style="display:block;" generated="true" class="error invalid-feedback"></span> 
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_3" style="<?php 
                                                                                                                            if (!empty($single_birthday)) {
                                                                                                                                if ($single_birthday->for_service == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="anniversary_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="new_client">Anniversary Offers</h3> 
                                    <div> 
                                        <?php if (!empty($single_anniversary)) { ?> 
                                            <?php if ($single_anniversary->discount_status == '0') { ?> 
                                                <a onclick="return confirm('Are you sure you want to activate the marketing discount?');" href="<?= base_url(); ?>activate_marketing_discount/4" title="Active Marketing Discount">
                                                    <i id="discount_status_on_4" class="fa-solid fa-toggle-off" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } else { ?> 
                                                <a onclick="return confirm('Are you sure you want to inactivate the marketing discount?');" href="<?= base_url(); ?>inactivate_marketing_discount/4" title="Inactive Marketing Discount">
                                                    <i id="discount_status_off_4" style="color: green;" class="fa-solid fa-toggle-on" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } ?> 
                                        <?php } ?> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_4" id="discount_in_4" class="form-control chosen-select">
                                            <option value="">Select Discount In</option>
                                            <option value="0" <?php if (!empty($single_anniversary) && $single_anniversary->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_anniversary) && $single_anniversary->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        <label>Discount Amount<b class="require">*</b></label> 
                                        <input autocomplete="off" value="<?php if (!empty($single_anniversary)) { echo $single_anniversary->discount_amount; } else {  echo "20"; } ?>" type="text" name="discount_amount_4" id="discount_amount_4" class="form-control" placeholder="Discount Amount"> 
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                        <input type="radio" name="service_option_4" id="all_service_4" value="0" <?php if (!empty($single_anniversary) && $single_anniversary->for_service == '0') { echo 'checked'; } ?> onclick="toggleServiceDropdown_4()">
                                        <span>All service</span> 
                                        <input type="radio" name="service_option_4" id="selected_service_4" value="1" <?php if (!empty($single_anniversary) && $single_anniversary->for_service == '1') { echo 'checked'; } ?> onclick="toggleServiceDropdown_4()">
                                        <span>Selected service</span> 
                                        <span for="service_option_4" style="display:block;" generated="true" class="error invalid-feedback"></span> 
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_4" style="<?php 
                                                                                                                            if (!empty($single_anniversary)) {
                                                                                                                                if ($single_anniversary->for_service == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                    ...
                    <div class="container">
                        <div class="row">
                            <form method="POST" id="product_marketing_form">
                                <div style="margin-bottom: 0 !important;padding-left:0;display: flex;justify-content:space-between;align-items:center;" class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                    <h3 style="font-size: 16px;font-weight: 800; color: var(--primary);" id="product_marketing" name="product_marketing">Product Marketing</h3> 
                                    <div> 
                                        <?php if (!empty($single_product_marketing)) { ?> 
                                            <?php if ($single_product_marketing->discount_status == '0') { ?> 
                                                <a onclick="return confirm('Are you sure you want to activate the marketing discount?');" href="<?= base_url(); ?>activate_marketing_discount/5" title="Active Marketing Discount">
                                                    <i id="discount_status_on_5" class="fa-solid fa-toggle-off" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } else { ?> 
                                                <a onclick="return confirm('Are you sure you want to inactivate the marketing discount?');" href="<?= base_url(); ?>inactivate_marketing_discount/5" title="Inactive Marketing Discount">
                                                    <i id="discount_status_off_5" style="color: green;" class="fa-solid fa-toggle-on" style="cursor: pointer;"></i>
                                                </a> 
                                            <?php } ?> 
                                        <?php } ?> 
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_in_5" id="discount_in_5" class="form-control chosen-select">
                                            <option value="">Select Discount In</option>
                                            <option value="0" <?php if (!empty($single_product_marketing) && $single_product_marketing->discount_in == '0') {
                                                                    echo 'selected';
                                                                } ?>>Percentage</option>
                                            <option value="1" <?php if (!empty($single_product_marketing) && $single_product_marketing->discount_in == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flat</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12"> 
                                        ...
                                        <select name="discount_type_5" id="discount_type_5" class="form-control chosen-select">
                                            <option value="">Select Discount Type</option>
                                            <option value="1" <?php if (!empty($single_product_marketing) && $single_product_marketing->discount_type == '1') {
                                                                    echo 'selected';
                                                                } ?>>Flexible</option>
                                            <option value="0" <?php if (!empty($single_product_marketing) && $single_product_marketing->discount_type == '0') {
                                                                    echo 'selected';
                                                                } ?>>Fixed</option>
                                        </select> 
                                    </div>
                                    <div class="form-group col-md-4 col-sm-4 col-xs-12 product_regular_discount_amount" style="<?php 
                                                                                                                                    if (!empty($single_product_marketing)) {
                                                                                                                                        if ($single_product_marketing->discount_type == '0') {
                                                                                                                                            echo 'display: block;';
                                                                                                                                        } else {
                                                                                                                                            echo 'display: none;';
                                                                                                                                        }
                                ...
                                <div class="row">
                                    <div class="form-group product_flexible_discount col-md-4 col-sm-4 col-xs-12 product_flexible_min" style="<?php 
                                                                                                                                                    if (!empty($single_product_marketing)) {
                                                                                                                                                        if ($single_product_marketing->discount_type == '1') {
                                                                                                                                                            echo 'display: block;';
                                                                                                                                                        } else {
                                                                                                                                                            echo 'display: none;';
                                                                                                                                                        }
                                    ...
                                    <div class="form-group product_flexible_discount col-md-4 col-sm-4 col-xs-12 product_flexible_max" style="<?php 
                                                                                                                                                    if (!empty($single_product_marketing)) {
                                                                                                                                                        if ($single_product_marketing->discount_type == '1') {
                                                                                                                                                            echo 'display: block;';
                                                                                                                                                        } else {
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group"> 
                                        <input type="radio" name="service_option_5" id="all_service_5" <?php if (!empty($single_product_marketing) && $single_product_marketing->for_product == '0') { echo 'checked'; } ?> value="0" onclick="toggleServiceDropdown_5()">
                                        <span>All Product</span> 
                                        <input type="radio" name="service_option_5" id="selected_service_5" <?php if (!empty($single_product_marketing) && $single_product_marketing->for_product == '1') { echo 'checked'; } ?> value="1" onclick="toggleServiceDropdown_5()">
                                        <span>Selected Product</span> 
                                        <span for="service_option_1" style="display:block;" generated="true" class="error invalid-feedback"></span> 
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12" id="serviceDropdown_5" style="<?php 
                                                                                                                            if (!empty($single_product_marketing)) {
                                                                                                                                if ($single_product_marketing->for_product == '1') {
                                                                                                                                    echo 'display: block;';
                                                                                                                                } else {
                                                                                                                                    echo 'display: none;';
                                                                                                                                }
                                            ...
                                            <?php 
                                                if (!empty($all_products)) {
                                                    ...
                                                    foreach ($all_products as $all_services_result) { ?> 
                                                        <option value="<?= $all_services_result->id ?>" <?php if (!empty($single_product_marketing) && in_array($all_services_result->id, $selected_services) && $single_product_marketing->for_product == '1') { echo 'selected'; } ?>> 
