                ...
                <div class="x_content">
                    <div class="container">
                        <form method="post" name="add_customer_form" id="add_customer_form" enctype="multipart/form-data">
                            ...
                            <!-- </div>
                            <div class="row"> -->
                                <div class="form-group col-md-4 col-sm-6 col-xs-12" id="giftcard_div" style="display:none;">
                                    ...
                                    <option value="" class="">Select Giftcard</option>
                                    </select>
                                </div>
                                <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <label>Giftcard Price<b class="require">*</b></label>
                                    <input onkeyup="setGST()" value="" autocomplete="off" type="text" class="form-control" name="price" id="price" placeholder="Enter price">
                                </div>
...
$(document).ready(function() {
    ...
    $('#giftcard_id').on('change', function() {
        $('#giftcard_id').valid();
    });
...
$("#show_more").click(function () {
    ...
    $("#customer_phone").keyup(function() {
        $('#giftcard_id option').each(function() {
    ...
    function get_customer_info(phone,id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>salon/Ajax_controller/get_customer_single_details_ajax",
            data: {
                'phone':phone,
                'customer':id,
            },
    ...
    $(document).ready(function() {
        ...
        $('.asign_giftcard').addClass('active_cc');
    });
</script>
