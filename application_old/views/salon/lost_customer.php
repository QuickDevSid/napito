    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Lost Customer <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_lost_customer_data_ajx",
                        "type": "POST",
                        "data": function (d) {
...
function showTemplate() {
    const name = "{{Customer}}";
    const offer = "{{Discount Text}}";
    const signature = "{{Salon Details}}";

    const message = `
        <p>Dear ${name},</p>
        <p>We noticed you haven’t visited us in a while, and we truly miss you!</p>
        <p>Your satisfaction is our priority, and we’d love to welcome you back with a special offer.</p>
        <p>🎁 Enjoy ${offer} on your next visit!</p>
        <p>Don’t miss out—this offer is valid for a limited time!</p>
        <p>If there’s anything we can improve or assist you with, please let us know.</p>
...
<script>
    $(document).ready(function() {
        ...
        $('.lost-customer-setup').addClass('active_cc');
    });
</script>
