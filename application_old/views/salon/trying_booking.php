    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Trying For Booking <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
            ...
            <div class="x_content">   
                <div class="container">     
                    ...
                    <form method="get" name="report_filter_form" id="report_filter_form" enctype="multipart/form-data" style="display:none;">        
                        ...
                        <input type="hidden" name="trying_booking_report_filter_type" id="trying_booking_report_filter_type" value="<?php if(isset($_GET['trying_booking_report_filter_type'])){ echo $_GET['trying_booking_report_filter_type']; }?>">
                    </form>
                    <div>
                        <label id="custom_date_label"></label>
                    </div>
                    <div class="content navtab_content new-content" id="report_content">  
                        <div class="x_title"> 
                        </div>
...
if(isset($_GET['trying_booking_report_filter_type']) && $_GET['trying_booking_report_filter_type'] != ""){
    $trying_booking_report_filter_type = $_GET['trying_booking_report_filter_type'];
}else{
    $trying_booking_report_filter_type = '1';
}
?>
...
<script>
    ...
    var trying_booking_report_filter_type = '<?php echo $trying_booking_report_filter_type; ?>';
    var monthNames = [
    ...
    $(document).ready(function() {
        ...
        fetchReportData(trying_booking_report_filter_type);
    });
        ...
        function fetchReportData(selected_filter_type = ''){
            ...
            if(selected_filter_type == ''){
                selected_filter_type = $('#trying_booking_report_filter_type').val();
            }
            ...
            setTimeout(function() {
                ...
                table = $('#1_table').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_trying_booking_marketing_report_data_ajx",
                        "type": "POST",
                        "data": function (d) {
                            d.from_date = start;
                            d.to_date = end;
                            d.customer_report_type = selected_filter_type;
                            d.marketing_type = '23';
                        }				
                    },
                    "complete": function() {
        ...
        function showForm(){
            ...
            $('#trying_booking_report_filter_type').val('6');
        ...
        function showTemplate() {
            ...
            const date = "{{Date}}";
            const timeSlot = "{{Time Slots}}";
            const salonName = "{{Salon Details}}";

            const message = `
                <p>Hello ${customerName},</p>
                <p>We noticed you had tried booking earlier, but your preferred time might not have been available.</p>
                <p>Good news! A customer just canceled their appointment, and this time slot is now open:</p>
                <p>📆 ${date}<br>⏰ ${timeSlot}</p>
                <p>If this timing works for you, please book quickly through the Napito App.</p>
                <p>Thank you!<br>${salonName}</p>
            `;
...
<script>
    $(document).ready(function() {
        ...
        $('.trying-booking').addClass('active_cc');
    });
</script>
