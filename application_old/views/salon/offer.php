    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Offer <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
<!-- 
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_offer_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            const occasion = "{{Festive Season}}";
            const salon = "{{Salon Name}}";
            const discount = "{{Discount Text}}";
            const startDate = "{{From Date}}";
            const endDate = "{{To Date}}";

            const message = `
                <p>🌟 Festival Offer Alert! 🌟</p>
                <p>Celebrate ${occasion} with ${salon}!</p>
                <p>Get ${discount} off on all services from ${startDate} to ${endDate}.</p>
                <p>Hurry, book your appointment now!</p>
            `;
...
<script>
    $(document).ready(function() {
        ...
        $('.offer-setup').addClass('active_cc');
    });
</script>
