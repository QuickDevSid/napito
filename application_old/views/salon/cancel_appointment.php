    ...
    $(document).ready(function() {
        ...
        function showTemplate() {
            ...
            const message = `
                ...
                <p>We noticed you canceled your appointment yesterday.</p>
                <p>If you’re free today, please book your slot through the app and visit us.</p>
                <p>Looking forward to seeing you!<br>${signature}</p>
            `;
