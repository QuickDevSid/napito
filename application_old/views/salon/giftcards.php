    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Gift Cards <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
<!-- 
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_giftcards_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            const brand = "{{Salon Name}}";

            const message = `
                <p>🎁 Gift the Joy of Beauty & Wellness! 🎁</p>
                <p>Surprise your loved ones with premium beauty and care services from ${brand}.</p>
                <p>💌 How to Get & Share:</p>
                <ol>
                    <li>Open the Napito app.</li>
                    <li>Buy a gift card.</li>
                    <li>Share it from the app.</li>
                </ol>
...
<script>
    $(document).ready(function() {
        ...
        $('.giftcards-setup').addClass('active_cc');
    });
</script>
