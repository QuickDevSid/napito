        ...
        <div class="row">
                            ...
                            <form method="post" name="employee_form" id="employee_form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 form-group" style="display:none;" id="person_name_div">
                                        ...
                                        <input autocomplete="off" class="form-control" type="text" name="name" id="name" value="<?php if (!empty($single)) {
                                                                                                                                    echo $single->entry_by;
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <select class="form-control chosen-select" id="type" name="type" onchange="setProductSelection()">
                                            ...
                                            <option value="0" <?php if (!empty($single) && $single->type == '0') {
                                                                    echo 'selected';
                                                                } ?> <?php if ($profile->current_petty_cash_balance == null || $profile->current_petty_cash_balance == '' || (float)$profile->current_petty_cash_balance <= 0) {
                                                                                                                                            echo 'disabled';
                                                                                                                                        } ?>>Debit</option>
                                            <option value="1" <?php if (!empty($single) && $single->type == '1') {
                                                                    echo 'selected';
                                                                } ?>>Credit</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <input readonly autocomplete="off" class="form-control" type="text" name="opening_balance" id="opening_balance" value="<?php if (!empty($single)) {
                                                                                                                                                                    echo $single->opening_balance;
                                                                                                                                                                } ?>" placeholder="Enter Opening Balance">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <label>Amount <b class="require">*</b></label>
                                        <input readonly type="text" autocomplete="off" placeholder="Enter Amount" class="form-control" name="amount" id="amount" value="<?php if (!empty($single)) {
                                                                                                                                                                            echo $single->amount;
                                                                                                                                                                        } ?>" onkeyup="setProductSelection()">
                                        <input autocomplete="off" class="form-control" type="hidden" name="id" id="id" value="<?php if (!empty($single)) {
                                                                                                                                    echo $single->id;
                                                                                                                                } ?>">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <input readonly autocomplete="off" class="form-control" type="text" name="closing_balance" id="closing_balance" value="<?php if (!empty($single)) {
                                                                                                                                                                    echo $single->closing_balance;
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <textarea autocomplete="off" class="form-control" name="remark" id="remark"><?php if (!empty($single)) {
                                                                                                                        echo $single->remark;
                                                                                                                    } ?></textarea>
                                    </div>
                                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <div class="container">
                            <form method="get" name="employee_filter_form" id="employee_filter_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 form-group">
                                        <label>Select Employee</label>
                                        <select class="form-control get_attendance chosen-select" name="selected_employee" id="selected_employee">
                                            <option value="">All Employee</option>
                                            <?php if (!empty($employee)) {
                                                foreach ($employee as $employee_result) { ?>
                                                    <option value="<?= $employee_result->id ?>" <?php if (isset($_GET['selected_employee']) && $_GET['selected_employee'] == $employee_result->id) { ?>selected="selected" <?php } ?>><?= $employee_result->full_name ?></option>
                                            <?php }
                                            } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        ...
                                        <input readonly type="text" class="form-control" placeholder="Select From Date" name="from_date" id="from_date" value="<?php if(isset($_GET['from_date']) && $_GET['from_date'] != ""){ echo date('d-m-Y',strtotime($_GET['from_date'])); } ?>">
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <label>To Date</label>
                                        <input readonly type="text" class="form-control" placeholder="Select To Date" name="to_date" id="to_date" value="<?php if(isset($_GET['to_date']) && $_GET['to_date'] != ""){ echo date('d-m-Y',strtotime($_GET['to_date'])); } ?>">
                                    </div>
                                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 " style="margin-top: 25px;margin-left:-10px">
                                        <button type="submit" id="filter_button" class="btn btn-primary">Search</button>
                                    </div>
                                </div>
                            </form>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr style="background-color:<?= $style; ?>">
                                                ...
                                                <td><?= date('d-m-Y h:i A', strtotime($product_master_list_result->created_on)) ?></td>
