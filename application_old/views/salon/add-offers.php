                                            ...
                                            <select class="form-select form-control chosen-select" name="service_name[]" id="service_name" multiple>
                                                ...
                                                <?php if (!empty($service_title)) {
                                                    ...
                                                    foreach ($service_title as $service_name) { ?>
                                                        <option value="<?= $service_name->id ?>" <?php if (in_array($service_name->id,$service_exp)){?>selected="selected"<?php }?>><?=$service_name->sub_cat_name . ' - ' . $service_name->service_name . ' | ' . $service_name->service_name_marathi; ?></option>
                                                <?php }
                                                } ?>
                                            </select>
