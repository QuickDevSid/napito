    ...
    <div>
        <div class="page-title">
            <div class="title_left">
                <h3>
                    Birthday <button class="btn btn-primary" onclick="showTemplate()">Template</button>
                </h3>
            </div>
                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Next Birthday<br><small>(In Days)</small></th>
    ...
    $(document).ready(function() {
        ...
        function fetchReportData(customer_report_type){
            ...
            setTimeout(function() {
                ...
                table = $('#example').DataTable({
                    ...
                    scrollCollapse: true,
                    "ajax":{
                        "url" : "<?=base_url();?>salon/Ajax_controller/get_marketing_birthday_data_ajx",
                        "type": "POST",
                        "data": function (d) {
        ...
        function showTemplate() {
            ...
            const message = `
                ...
                <p>Enjoy a special ${discount_text} as our birthday treat, valid during your birthday week.</p>
                <p>Book your appointment now and celebrate in style!</p>
                <p>Warm wishes,<br>${signature}</p>
            `;
...
<script>
    $(document).ready(function() {
        ...
        $('.birthday-setup').addClass('active_cc');
    });
</script>
