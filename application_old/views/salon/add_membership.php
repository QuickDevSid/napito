                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="custom_fields_data">
                                                    ...
                                                    <input autocomplete="off" type="text" class="color_value_input" name="bg_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->bg_color;}else{ echo '#808080';} ?>" id="hexcolor">
                                            ...
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="custom_fields_data">
                                                    ...
                                                    <input autocomplete="off" type="text" class="button_text_color_input" name="text_color_input" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="<?php if(!empty($single_setup_membership)){ echo $single_setup_membership->text_color;}else{ echo '#000000';} ?>" id="texthexcolor">
