        ...
        <div class="row">
            <div class="tabs" id="exTab2">
                <ul class="nav nav-tabs message-tab">
                    ...
                    <li>
                        <a class="" href="<?=base_url()?>employee_incentive_master<?php if(isset($_GET['redirect'])){ echo '?redirect=' . $_GET['redirect']; }?>" >Empolyee Incentive</a>
                    </li>
                    <!--<li>-->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                    ...
                                                    <?php } ?>
                                                        <a title="Edit" class="btn btn-success" href="<?=base_url()?>add_employee/<?=$salon_employee_list_result->id?><?php if(isset($_GET['redirect'])){ echo '?redirect=' . $_GET['redirect']; }?>"><i class="fa-solid fa-pen-to-square"></i></a> 
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        $sub_category_names = $salon_employee_list_result->sub_category_names;
                                                                        $sub_category_marathi_names = $salon_employee_list_result->sub_category_marathi_names;
                                                                        $sup_category_names = $salon_employee_list_result->sup_category_names;
                                                                        $sup_category_marathi_names = $salon_employee_list_result->sup_category_marathi_names;
                                                                        $genders = $salon_employee_list_result->genders;
                                                                        
                                                                        if ($services != "" && $service_names_marathi != "") {
                                                                            $serviceArray = explode(',', $services);
                                                                            $serviceMarathiArray = explode(',', $service_names_marathi);
                                                                            $sub_category_namesArray = explode(',', $sub_category_names);
                                                                            $sub_category_marathi_namesArray = explode(',', $sub_category_marathi_names);
                                                                            $sup_category_namesArray = explode(',', $sup_category_names);
                                                                            $sup_category_marathi_namesArray = explode(',', $sup_category_marathi_names);
                                                                        ...
                                                                        ?>
                                                                            <table style="width:100%;" class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    for ($i = 0; $i < $length; $i++) {
                                                                                        $single_gender = $gendersArray[$i];
                                                                                        if($single_gender == '0'){
                                                                                            $single_gender = 'Male';
                                                                                        }elseif($single_gender == '1'){
                                                                                            $single_gender = 'Female';
                                                                                        }else{
                                                                                            $single_gender = '-';
                                                                                        }
                                                                                        echo '<tr>';
                                                                                        echo '<td style="width:15%;">' . $serialNumber . '</td>';
                                                                                        echo '<td style="width:35%;">' . trim($sup_category_namesArray[$i]) . ' | ' . trim($sup_category_marathi_namesArray[$i]) . '<br><small>' . trim($sub_category_namesArray[$i]) . ' | ' . trim($sub_category_marathi_namesArray[$i]) . '</small></td>';
                                                                                        echo '<td style="width:35%;"><b>' . trim($serviceArray[$i]) . '</b><br>' . trim($serviceMarathiArray[$i]) . '</td>';
                                                                                        echo '<td style="width:15%;">' . $single_gender . '</td>';
                                                                                        echo '</tr>';
                                                                                        $serialNumber++;
                                                                                    }
                                                                                    ?>
                                                   ...
                                                   if(!empty($salary_method)){
                                                    ...
                                                    <td>
                                                        <?php
                                                         ...
                                                         <a class="btn btn-primary" target="_blank" href="<?= base_url(); ?>admin_assets/images/employee_profile/<?=$salon_employee_list_result->profile_photo?>">View</a>
                                                        <?php } else{
                                                            echo "-";
                                                          }
                                                        ?>
                                                   ...
                                                   <td>
                                                    ...
                                                    <?php
                                                       ...
                                                       <a class="btn btn-primary" target="_blank" href="<?= base_url(); ?>admin_assets/images/employee_aadhar/<?=$salon_employee_list_result->identy_proof?>">View</a>
                                                        <?php } else{
                                                            echo "-";
                                                          }
                                                        ?>
                                                   ...
                                                   <td>
                                                    <?php if($salon_employee_list_result->description != ""){ ?>
                                                        ...
                                                        <!-- <a class="btn btn-primary" data-popup-open="popup-1" onclick="view_description('<?php echo $salon_employee_list_result->description; ?>')">View</a> -->
                                                    <?php }else{ ?>
                                                        -
                                                    <?php } ?>
                                                    </td>
