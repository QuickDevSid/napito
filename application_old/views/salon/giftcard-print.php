    ...
    <div class="tm_invoice_wrap">
      <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
        <div class="tm_invoice_in">
          ...
          <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Payment Status: </b>Completed</div>
          <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0"><b>Receipt No: </b><?=$single_profile->salon_id?><?=$single_profile->id?><?=$single_profile->id?><?=$customer_amount->id?> </b></p>
              <p class="tm_invoice_date tm_m0"><b>Date: </b><?php echo ($customer_amount->payment_date != "") ? date('d/m/Y',strtotime($customer_amount->payment_date)) : '-'; ?></b></p>
            </div>
                ...
                <table>
                  <thead>
                    <tr class="tm_accent_bg">
                      ...
                      <th class="tm_width_2 tm_semi_bold tm_white_color" style="width:30%;">Giftcard</th>
                      <th class="tm_width_2 tm_semi_bold tm_white_color" style="width:35%;">Details</th>
                  ...
                  <tbody>
                    <tr>
                      <td class="tm_width_4" style="width:15%;"><b>Giftcard Payment</b></td>
                      <td class="tm_width_2" style="width:30%;"><b><?=$customer_amount->gift_name?></b></td>
                      <td class="tm_width_2" style="width:35%;">
                        <p style="margin:0px;"><b>Code:</b> <span style="font-size: 12px;"><?=$customer_amount->giftcard_customer_uid?></span></p>
                        <p style="margin:0px;"><b>Giftcard Worth:</b> <span style="font-size: 12px;">Rs. <?=number_format((float)$customer_amount->gift_card_price, 2, '.', '')?></span></p>
                      </td>
                      <td class="tm_width_2 tm_text_right" style="width:20%;"><b><?=number_format((float)$customer_amount->gift_card_regular_price, 2, '.', '')?></b></td>
                    </tr> 
                  </tbody>
                </table>
              </div> 
                ...
                <table class="tm_mb15">
                  ...
                  <?php if ($customer_amount->discount_in_rs > 0) { ?>
                    ...
                    <!-- <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right"><?=number_format(((float)$customer_amount->gift_card_regular_price - ($customer_amount->discount_in_rs != "" ? $customer_amount->discount_in_rs : 0.00)), 2, '.', '')?></td>
                    </tr> -->
                    <?php if($customer_amount->is_gst_applicable == '1'){ ?>
                             <tr class="tm_gray_bg">
                        ...
                        <?php } ?>
                            <tr class="tm_accent_bg">
                                ...
                                <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right"><?php echo $customer_amount->giftcard_final_amount != "" ? number_format((float)($customer_amount->giftcard_final_amount), 2, '.', '') : (((float)$customer_amount->gift_card_regular_price - ($customer_amount->discount_in_rs != "" ? $customer_amount->discount_in_rs : 0.00) + $customer_amount->gst_amount)); ?></td>
                            </tr>
