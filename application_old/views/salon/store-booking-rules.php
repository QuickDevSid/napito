						...
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									...
									<?php if($store_type == '1'){ ?>
										<input type="radio" class="" name="employee_selection" id="employee_selection_multiple" value="0" <?php if(!empty($single_rules) && $single_rules->employee_selection == "0"){?>checked="checked"<?php }?>><span>Select Multiple stylists from the backend | अनेक स्टायलिस्ट निवड </span>
										<!-- <input type="radio" class="" name="employee_selection" id="employee_selection_single" value="1" <?php if(!empty($single_rules) && $single_rules->employee_selection == "1"){?>checked="checked"<?php }?>><span>Select Single stylist from the backend | एक स्टायलिस्ट</span> 
										<input type="radio" class=" " name="employee_selection" id="employee_selection_single_frontend" value="2" <?php if(!empty($single_rules) && $single_rules->employee_selection == "2"){?>checked="checked"<?php }?>><span>Select Single stylist from the frontend | एक स्टायलिस्ट</span> -->
									<?php }elseif($store_type == '2'){ ?>
										<input type="radio" class="" name="employee_selection" id="employee_selection_single" value="1" <?php if(!empty($single_rules) && $single_rules->employee_selection == "1"){?>checked="checked"<?php }?>><span> Select a single stylist from the backend |एक स्टायलिस्ट निवड (बॅकएंडवरून)</span> 
										<br>
										<input type="radio" class=" " name="employee_selection" id="employee_selection_single_frontend" value="2" <?php if(!empty($single_rules) && $single_rules->employee_selection == "2"){?>checked="checked"<?php }?>><span>Select a single stylist from the frontend | एक स्टायलिस्ट निवड (फ्रंटएंडवरून)</span>
									<?php } ?>
				...
				<div class="x_panel">
                    <div class="x_content">
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-4 col-sm-6 col-xs-12 form-group">
									<label class="rs_label" id="slot_time_label">Slot Time | स्लॉट वेळ<b class="require">*</b></label>
						...
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label id="buffering_time_label" class="rs_label">Buffering Time | ब्रेक (Break between two appointments | दोन अपॉइिंटमेंट मधील ब्रेक)<b class="require">*</b></label>
				...
				<div class="x_panel">
                    <div class="x_content">
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label class="rs_label" id="rescheduling_label">Booking Rescheduling | बुकिंगमध्ये बदल करणे <b class="require">*</b> <small >How much time in advance can an appointment be rescheduled? | अपॉइंटमेंट किती वेळ आधी बदलता येईल?</small></label>
				...
				<div class="x_panel">
                    <div class="x_content">
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label class="rs_label" id="cancellation_label">Booking Cancellation | बुकिंग रद्द करणे<b class="require">*</b><small>How much time in advance can an appointment be canceled? | अपॉइंटमेंट किती वेळ आधी रद्द करता येईल?</small></label>
				...
				<div class="x_panel">
                    <div class="x_content">
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label class="rs_label" id="reward_point_cancellation_main_label">Reward Point Cancellation | रिवॉर्ड पॉइंट रद्द करणे</label>
									<label class="rs_label" id="reward_point_cancellation_label">Cancel Appointment | ग्राहकाने अपॉइंटमेंट रद्द केल्यास<b class="require">*</b></label>
									<input type="radio" class=" " name="reward_point_cancellation" id="reward_point_cancellation" value="1" <?php if(!empty($single_rules) && $single_rules->reward_point_cancellation == "1"){?>checked="checked"<?php }?>><span>Rewards earned on canceled bookings will be reduced | रद्द केलेल्या बुकिंगवर मिळणारे रिवॉर्ड कमी केले जातील</span>    
								</div>  
									...
									<?php 
										if(!empty($single_rules)){ 
											if($single_rules->reward_point_cancellation == '1'){
												echo 'Rewards earned on canceled bookings will be reduced | रद्द केलेल्या बुकिंगवर मिळणारे रिवॉर्ड कमी केले जातील';
											}
										} 
									?>
								"> 
				...
				<div class="x_panel">
                    <div class="x_content">
						<div class="container"> 
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label id="booking_time_range_main_label">Booking Time Range | बुकिंगची वेळ मर्यादा</label>
								</div> 
							</div>  
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label class="rs_label" id="booking_time_range_label">How much time in advance can a booking be made? | बुकिंग किती वेळ आधी करता येईल?<b class="require">*</b></label>
									<!-- <input type="radio" class=" " name="booking_time_range" id="booking_range_one" value="30" <?php if(!empty($single_rules) && $single_rules->booking_time_range == "30"){?>checked="checked"<?php }?>><span>Before 30 Minutes</span>     -->
									<input type="radio" class=" " name="booking_time_range" id="booking_range_twwo" value="15" <?php if(!empty($single_rules) && $single_rules->booking_time_range == "15"){?>checked="checked"<?php }?>><span>Before 15 Minutes</span>    
								</div>  
							...
							<div class="row"> 
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<label class="rs_label" id="max_booking_range_day_label">For how many days in advance can a booking be made? | किती दिवसांपर्यंत आगाऊ बुकिंग करता येईल? <b class="require">*</b></label>
