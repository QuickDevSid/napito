                                    ...
                                    <table class="table table-striped" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($facility_list_result->is_deleted == "1"){?>
                                                    <a title="Use this" class="btn btn-danger" onclick="return confirm('Are you sure to add this facility?');" href="<?=base_url()?>delete/<?=$facility_list_result->id?>/tbl_salon_facility_master?recover="1">Use this</a>	
                                                    <?php }else{?>
