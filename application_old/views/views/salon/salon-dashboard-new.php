...
<div class="right_col" role="main">
    ...
    <?php } else { ?>
        ...
        <div class="row dashboard_list_links_row" id="counts_div" style="display:none;">
            <div class="col-md-12 dashboard_menu_list">
                ...
                <div class="btn btn-light dashboard_list_btn">
                    <input id="today_date" placeholder="DD/MM/YYYY" value="<?php $currentDate = date("d/m/Y");
                                                                            echo $currentDate; ?>">
                    <input type="hidden" id="dummy_t_date" placeholder="DD/MM/YYYY" value="<?php $currentDate = date("d/m/Y");
                                                                                            echo $currentDate; ?>">
                </div>
                <div class="btn btn-primary dashboard_list_btn">
                    ...
                    <!-- <button class="btn btn-primary dashboard_list_btn show_nav"><i class='fa fas-left-arrow'></i>Show Less</button> -->
                    ...
                    ?>
                            <div class="navtab" id="stylist_tab_<?= $salon_employee_list_result->id; ?>" data-target="home" onclick="setStylistCalendar(<?= $salon_employee_list_result->id; ?>)">
                                <div class="stylist_sale_details_info" id="stylist_sale_details_info_<?= $salon_employee_list_result->id; ?>">
                                    ...
                                    <div class="stylist-sale-tooltip tooltip_down" style="<?= $back_color; ?>">
                                        <?php if ($att_text != "") { ?>
        ...
        <div class="<?php if (empty(array_intersect(['booking_calendar'], $feature_slugs))) {
            ...
            <div id="calendar" class="dashboard_calander"></div>
        </div>
...
<script>
    ...
    // var wsSocketURL = SOCKET_BASE_URL + "?project=" + project + "&branch=" + branch_id + "&salon=" + salon_id + "&type=" + type;
