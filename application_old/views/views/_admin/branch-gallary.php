                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td> <a target="_blank" href="<?= base_url() ?>\admin_assets\images\gallary_image/<?= $gallary_list_result->gallary_image ?>">View
                                            </a></td>
                                        <td>
                                            <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?');" href="<?= base_url() ?>delete/<?= $gallary_list_result->id ?>/tbl_branch_gallary"><i class="fa-solid fa-trash"></i></a>
