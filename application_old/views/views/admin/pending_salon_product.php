                                            ...
                                            //    echo "<pre>"; print_r($product);exit;
                                                if(!empty($product)){
                                                    ...
                                                    foreach($product as $product_result){ 
                                                        ...
                                                        if($product_result->discount_in == '0'){
                                                            $discount_text = $product_result->discount . '%';
                                                        }elseif($product_result->discount_in == '1'){
                                                            $discount_text = 'Rs. ' . $product_result->discount;
                                                        }else{
                                                            $discount_text = '-';
                                                        }
                                                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            if ($product_result->product_photo != "") {
                                                                $images = explode(',',$product_result->product_photo);
                                                    ...
                                                    <td class="flex_div">
                                                        <a class="btn_info" href="<?=base_url()?>admin_product_add/<?=$product_result->id?>?pending"><span>Edit</span></a> 
