                            ...
                            <div class="x_panel">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if($add_salon_record_result->is_payment_gateway == '1'){
                                                    echo 'Yes';
                                                    if($add_salon_record_result->pancard_copy != ""){
                                                        echo '<br><a style="text-decoration:underline;" href="'.base_url().'admin_assets/images/owner_aadhar/'.$add_salon_record_result->pancard_copy.'" download>PAN Copy</a>';
                                                    }
                                                }else{
                                                    echo 'No';
                                                }
